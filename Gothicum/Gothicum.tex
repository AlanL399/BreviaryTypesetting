...
In Symbolo quod in Ecclesia canitur, processionem Spiritus sancti a Patre et Filio per illa verba, Qui a Patre Filioque procedit, primo a Patribus in conc. III Toletano solemniter fuisse conclamatam, omnes ultro fatentur; et admodum verisimile est Romanam Ecclesiam, dum decrevit ut in fine cujusque psalmi diceretur Gloria Patri, \&c., secutam fuisse Patrum Hispanorum consuetudinem in concilio IV Toletano stabilitam, ut semper in terminatione psalmorum pronuntiarentur verba Apocalypsis Gloria et honor, \&c. Et si sanctus Damasus Hispanus fuit auctor, majorem vim habebit nostra assertio.
...
\vspace{-.75em} \begin{center} \color{Red} \hypertarget{deut32} Canticum Deuteronomii. \itshape \color{black} Capitulo \upshape 32.\end{center} \vspace{-.75em}
...
\end{center}
\vspace{-.75em}
\bookmark[rellevel=-2,dest=JEJUNIORUM-JANUARII-MAT]{OFFICIUM JEJUNIORUM IN JANUARII}
\bookmark[rellevel=1,dest=JEJUNIORUM-JANUARII-MAT]{PRIMO DIE}
...
\vspace{-1.5em} \begin{center} {\color{Red} L}ectio libri Esai\ae \ Prophet\ae . \itshape Capitulo \upshape 46. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\vspace{-.5em} \begin{center} {\color{Red} S}equentia Epistol\ae \ Pauli Apostoli ad Corinthios secund\ae . \itshape Capitulo \upshape 6. \& 7. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\vspace{-.5em} \begin{center} \color{Red} Capitula. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus, cujus in regno credentium terra exultat, cujus justitiam c\oe li adnuntiant,
%pp127
cujus dominationem Angelorum legiones adorant; custodi servorum tuorum animas: ac ne peccati auctorem sequentes, intereamus: tu libera, tu protege, tu conserva: ut, cum ante faciem tuam ignis comburens pr\ae jerit, non nos meritorum p\oe na exurendos accipiat, sed clementia creatoris, ut vivamus, eripiat.
\par Pater noster. Et ne nos, \&c. A malo nos libera.  \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.9}{9.}
\vspace{-.5em} \begin{center} \color{Red} \hypertarget{JEJUNIORUM-JANUARII-VES} Ad Vesperum. \color{black} \end{center} \vspace{-1em}
\bookmark[dest=JEJUNIORUM-JANUARII-VES]{AD VESPERUM}
\par \noindent \color{Red} Lauda. \color{black} Vespere, mane, \& meridie te laudamus, Domine.
\newline \color{Red} Antiphona. \color{black} Salva plebem tuam, Domine, \& benedic hereditatem tuam. \color{Red} \hyperlink{ps27}{Psalmus 27.} \color{black}
\newline \color{Red} Lauda. \color{black} Veniat super nos, Domine, misericordia tua: \& salutare tuum, \& eloquium tuum. \V Et respondebo exprobrantibus mihi verbum: quia speravi in sermonibus tuis. \P Et eloquium tuum. \V Gloria, \& honor Patri, \&c. \P Et eloquium tuum.
\newline \color{Red} Hymnus. \color{black} Benignitatis fons Deus.
\newline \color{Red} Supplicatio. \color{black} Oremus Redemptorem mundi.
\newline \color{Red} Capitula. \color{black} Dilectissimi fratres.
\newline \color{Red} Benedictio. \color{black} Christus Dominus, qui cum Patre.
\newline \color{Red} Lauda. \color{black} Alleluia. L\ae tabitur deserta. \color{Red} Omnia supra dicta require fol. \color{black} \hyperlink{page.67}{67.} \& \hyperlink{page.68}{68.}
\newline \color{Red} Oratio. \color{black} Domine, exaudi orationem nostram. \color{Red} Require in isto folio. \color{black}
\vspace{-.25em} \begin{center} \hypertarget{JEJUNIORUM-JANUARII-MAT-II}
IN SECUNDO DIE.\\
\color{Red} Ad Matutinum.
\end{center}
\vspace{-.75em}
\bookmark[rellevel=-1,dest=JEJUNIORUM-JANUARII-MAT-II]{IN SECUNDO DIE}
\bookmark[rellevel=1,dest=JEJUNIORUM-JANUARII-MAT-II]{AD MATUTINUM}
...
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine, exaudi orationem nostram; \& clamor noster ad te remoto impedimento perveniat: quocumque autem die te invocamus, velociter tibi nostra patescat oratio: nec avertas faciem tuam a gemitibus; nec gubernationem tuam a nostris cohibeas moribus: ut gratulemur adipisci postulata; dum ad te nostra pervenerint desideria. \R Amen. Per misericordiam tuam, \&c.
\newline \R Hierusalem erit tibi Dominus lux \ae terna, \& Deus honor tuus non enim in hoc casu tibi veniet, sol \& luna non deficient. \P In \ae ternum tempus. \V Hierusalem non erit tibi sol amplius ad lucendum per diem, nec splendor lun\ae \ illuminabit te in nocte; sed erit tibi Dominus in luce. \P In \ae ternum.
\vspace{-.25em} \begin{center} \hypertarget{JEJUNIORUM-JANUARII-LAU-II}
IN LAUDIBUS.
\end{center}
\vspace{-.75em}
\bookmark[dest=JEJUNIORUM-JANUARII-LAU-II]{IN LAUDIBUS}
\par \noindent \color{Red} Antiphona. \color{black} Averte faciem tuam a peccatis meis: \& omnes iniquitates meas dele. \color{Red} \hyperlink{ps50}{Psalmus 50.} \color{black}
\newline \color{Red} Oratio. \color{black} Averte faciem tuam. \color{Red} Require fol. \color{black} \hyperlink{page.66}{66.}
\vspace{-.5em} \begin{center} \color{Red} Ad Canticum. \color{black} \end{center} \vspace{-.5em}
\par \noindent \color{Red} Antiphona. \color{black} Non est Deus sicut homo, ut mentiatur: nec ut filius hominis, ut immutetur.
\vspace{-.5em} \begin{center} {\color{Red} Canticum Numeri.} \itshape Capitulo \upshape 23. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}E Aram adduxit me Balac rex Moabitarum, de montibus Orientis: veni, inquit, \& maledic Jacob: * propera, \& detestare Israel. Quomodo maledicam, cui non maledixit Deus?
\newline {\color{Red} Q}ua ratione detester, * quem Deus non detestatur?
\newline {\color{Red} D}e summis silicibus videbo eum, * \& de collibus considerabo illum.
\newline {\color{Red} P}opulus solus habitabit, * \& inter gentes non reputabitur.
\newline {\color{Red} Q}uis dinumerare possit pulverem Jacob, * \& nosse numerum stirpis Israel?
\newline {\color{Red} M}oriatur anima mea morte justorum, * \&
%pp128
fiant novissima mea horum similia.
\newline {\color{Red} S}ta Balac \& ausculta, * audi fili Sephor:
\newline {\color{Red} N}on est Deus sicut homo, ut mentiatur: * nec ut filius hominis, ut immutetur.
\newline {\color{Red} D}ixit ergo, \& non faciet? * locutus est, \& non adimplebit?
\newline {\color{Red} A}d benedicendum adductus sum, * benedictionem prohibere non valeo.
\newline {\color{Red} N}on est idolum in Jacob, * nec videtur simulacrum in Israel.
\newline {\color{Red} D}ominus Deus ejus cum eo est, * \& clangor victori\ae \ regis in illo.
\newline {\color{Red} D}eus eduxit eum de \AE gypto, * cujus fortitudo similis est rhinoceroti.
\newline {\color{Red} N}on est augurium in Jacob, * nec divinatio in Israel.
\newline {\color{Red} T}emporibus suis dicetur Jacob \& Israel * quid operatus est Deus.
\newline {\color{Red} P}opulus ecce ut le\oe na consurgit, * \& leo erigitur:
\newline {\color{Red} N}on accubabit, donec devoret pr\ae dam, * \& occisorum sanguinem bibat.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
...
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Esai\ae \ Prophet\ae . \itshape Capitulo \upshape 2. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\vspace{-.5em} \begin{center} {\color{Red} S}equentia Epistol\ae \ Pauli Apostoli ad \\ Corinthios prim\ae . \itshape Capitulo \upshape 8. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\newline \color{Red} Preces. \color{black} Clamamus ad te, Domine, tu miserere nobis. \P Et dona indulgentiam. \V Rex altissime \& perennis Domine, precem, quam effundimus, accipe. \P Et dona. \V \AE gros visita \& captivos revoca, pupillos \& viduas adjuva. \P Et dona. \V Nos peccavimus \& a te recessimus, tu Redemptor omnium salva nos. \P Et dona. \V P\oe nitentibus miserere, Domine, \& peccati maculas ablue. \P Et dona.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} L}{}Audamus te Domine, quia benignus, ac suavis es: pr\ae sta itaque, ut dum in tua laudatione insistimus, vel a mundi nos illecebris advoces, vel perfectorum societati adglomeres.
\par Pater noster.
\vspace{-.5em} \begin{center} \color{Red} \hypertarget{JEJUNIORUM-JANUARII-SEX-II} Ad Sextam. \color{black} \end{center} \vspace{-1em}
\bookmark[dest=JEJUNIORUM-JANUARII-SEX-II]{AD SEXTAM}
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Esai\ae \ Prophet\ae . \itshape Capitulo \upshape 19. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} E}{}Cce Dominus ascendet super nubem levem, \& ingredietur \AE gyptum, \& movebuntur simulacra \AE gypti a facie ejus, \& cor \AE gypti tabescet in medio ejus. Et concurrere faciam \AE gyptios adversus \AE gyptios: \& pugnabit vir contra fratrem suum, \& vir contra amicum suum, \& civitas adversus civitatem, \& regnum adversus regnum. Et disrumpetur spiritus \AE gypti in visceribus ejus, \& consilium ejus pr\ae cipitabo: \& interrogabunt simulacra sua, \& divinos suos, \& pythones \& ariolos. Et tradam \AE gyptum in manu dominorum crudelium, \& rex fortis dominabitur eis, ait Dominus Omnipotens. \R Amen.
\newline \color{Red} Antiphona 1. \color{black} Laqueus contritus est, \& nos liberati sumus. \color{Red} \hyperlink{ps123}{Psalmus 123.} \color{black}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} E}{}Sto in nobis Domine Deus Israel: \& malorum infestationem, ne deglutiamur, a nobis repelle: nocivamque iracundiam, ne obsorbeamur comprime: sicque in nobis torrens tu\ae \ voluptatis redundet, ut vitiorum torrentem anima nostra se sine discrimine pertransisse exultet: neque inimicorum dentibus laniemur; sed ereptos nos de venantium laqueis gratulemur: \& tu adjutor noster heredita nos in possessione \ae terna; qui, cooperante Verbo tuo Sanctoque Spiritu, fecisti c\oe lum \& terram. \R Amen. Per misericordiam.
\newline \color{Red} Antiphona 2. \color{black} Converte Domine captivitatem nostram, sicut torrens in austro. \color{Red} \hyperlink{ps125}{Psalmus 125.} \color{black}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} C}{}Onvertere, Domine, captivitatem nostram ab inlecebrosis inimici seductionibus redimendo: \& reple consolatione indulgenti\ae , quos desolatos prospicis ob admisionem nequiti\ae : da nobis, qu\ae sumus, contriti cordis humilitatem qu\ae rere; \& inquinamenta, qu\ae \ nos polluunt, fluentis lachrymarum abluere: sic etiam confessionis remedia seramus in lachrymis, ut indulgenti\ae \ fructus metamus in gaudiis. \R Amen. Per.
\newline \color{Red} Antiphona 3. \color{black} Beati omnes, qui timent Dominum, qui ambulant in viis ejus. \color{Red} \hyperlink{ps127}{Psalmus 127.} \color{black}
\newline \R Miserere nobis, Domine. \P Miserere nobis. \V Ad te levamus oculus nostros, qui habitas in c\oe lis. \P Miserere nobis. \V Gloria, \& honor Patri, \&c. \P Miserere nobis.
%pp131
\newline \color{Red} Preces. \color{black} Clamemus omnes una voce. \P Domine miserere. \V Amara nobis est vita nostra. \P Domine miserere. \V Delicta dele, pacem concede. \P Domine miserere. \V Inclina aurem tuam ad precem nostram. \P Domine miserere. \V Parce delictis, \& subveni de c\oe lis. \P Domine miserere.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus, qui timentes te, beatos prophetali voce pronuntias; da in nobis tui timoris obsequia beneplacita; ut ex hoc in viis tuis ambulare nos facias: sitque, te gubernante, labor noster tuis oculis placitus; cujus fructus tempore remunerationis efficiatur suavissimus: ac sic labor ipse de charitate studeatur, ut apud te fruges ejus in beatitudine recondeantur.
\par Pater noster. Et ne nos, \&c.
\vspace{-.5em} \begin{center} \color{Red} \hypertarget{JEJUNIORUM-JANUARII-NON-II} Ad Nonam. \color{black} \end{center} \vspace{-1em}
\bookmark[dest=JEJUNIORUM-JANUARII-NON-II]{AD NONAM}
\vspace{-.5em} \begin{center} {\color{Red} P}roverbiorum Salomonis. \itshape Capitulo \upshape 21. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Deuteronomii. \itshape Capitulo \upshape 6. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} I}{}N illis diebus: Locutus est Moyses ad omnem c\oe tum filiorum Israel, \& dixit ad eos: Audi Israel, Dominus Deus vester, Deus unus est. Diliges Dominum Deum tuum ex toto corde tuo, \& ex tota fortitudine tua. Eruntque verba h\ae c, qu\ae \ ego pr\ae cipio tibi hodie, in corde tuo: \& narrabis ea filiis tuis, \& meditaberis sedens in domo tua, \& ambulans in itinere, dormiens atque consurgens. Et ligabis ea quasi signum in manu tua, eruntque \& movebuntur inter oculos tuos, scribesque ea in limine \& ostiis domus tu\ae . Cumque introduxerit te Dominus Deus tuus in terram, pro qua juravit patribus tuis, Abraham, Isaac, \& Jacob: \& dederit tibi civitates magnas \& optimas, quas non \ae dificasti, domos plenas cunctarum opum, quas non extruxisti, cisternas, quas non fodisti, vineta \& oliveta, qu\ae \ non plantasti, \& comederis, \& saturatus fueris: cave diligenter, ne obliviscaris Dominum, qui eduxit te de terra \AE gypti, \& de domo servitutis. Dominum Deum tuum timebis, \& ipsi servies, ac per nomen illius jurabis. Non ibitis post deos alienos cunctarum gentium, qu\ae \ in circuitu vestro sunt: quoniam Deus \ae mulator, Dominus Deus in medio tui: nequando irascatur furor Domini Dei tui contra te, \& auferat te desuper faciem terr\ae . Non tentabis Dominum Deum tuum, sicut tentasti in loco tentationis. Custodi pr\ae cepta Domini Dei tui, ac testimonia \& c\ae rimonias, quas pr\ae cepit tibi: \& fac quod placitum est \& bonum in conspectu Domini, ut bene sit tibi: \& ingressus possideas terram, quam Dominus Deus tuus daturus est tibi. \R Amen.
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Esai\ae \ Prophet\ae . \itshape Capitulo \upshape 49. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\vspace{-.5em} \begin{center} {\color{Red} S}equentia Epistol\ae \ Pauli Apostoli ad Ephesios. \itshape Capitulo \upshape 4. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\par Pater noster.
\vspace{-.5em} \begin{center} \color{Red} \hypertarget{JEJUNIORUM-JANUARII-VES-II} Ad Vesperum. \color{black} \end{center} \vspace{-1em}
\bookmark[dest=JEJUNIORUM-JANUARII-VES-II]{AD VESPERUM}
\par \noindent \color{Red} Lauda. \color{black} Sol agnovit occasum suum. Posuisti tenebras, \& facta est nox.
\newline \color{Red} Antiphona. \color{black} Disrumpe, Domine Deus, vincula peccatorum: ut sacrificemus tibi hostiam laudis. \color{Red} \hyperlink{ps115}{Psalmus 115.} \color{black}
\newline \color{Red} Lauda. \color{black} Tu mandasti mandata tua custodire nimis. \V Utinam dirigantur vi\ae \ me\ae , ad custodiendas justificationes tuas.
\newline \color{Red} Hymnus. \color{black} Benignitatis fons Deus.
\newline \color{Red} Supplicatio. \color{black} Oremus Redemptorem.
\newline \color{Red} Capitula. \color{black} Dilectissimi fratres.
\newline \color{Red} Benedictio. \color{black} Christus Dominus.
\newline \color{Red} Lauda. \color{black} Alleluia. L\ae tabitur. \color{Red} fol. \color{black} \hyperlink{page.66}{66.} \& \hyperlink{page.67}{67.}
\newline \color{Red} Oratio. \color{black} Ne projicias nos. \color{Red} Qu\ae re infra in Matutinis sequentibus. \color{black}
\par \color{Red} De jejunio Epiphani\ae . Omnes jejunemus ad exorandum Dominum nostrum Jesum Christum pro peccatis nostris, ac pace impetranda; vel ad sacras lectiones audiendas Ecclesiam Domini frequentemus. \color{black}
\vspace{-1.25em} \begin{center} \color{Red} \hypertarget{JEJUNIORUM-JANUARII-MAT-III}
TERTIO DIE.\\
\color{black} \scshape Quod est Vigilia Epiphani\ae \ Domini.\\
\upshape \color{Red} Ad Matutinum.
\end{center}
\vspace{-.75em}
\bookmark[rellevel=-1,dest=JEJUNIORUM-JANUARII-MAT-III]{TERTIO DIE}
\bookmark[rellevel=1,dest=JEJUNIORUM-JANUARII-MAT-III]{AD MATUTINUM}
\par \noindent \color{Red} Antiphona. \color{black} Tu autem Domine susceptor meus es, gloria mea, \& exaltans caput meum. \color{Red} \hyperlink{ps3}{Psalmus 3.} \color{black}
\newline \color{Red} Oratio. \color{black} Quamvis Domine. \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.65}{65.}
\newline \color{Red} Antiphona 1. \color{black} Bene nuntiate de die in diem salutare ejus. \color{Red} \hyperlink{ps95}{Psalmus 95.} \color{black}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} C}{}Antet tibi novum canticum numerositas redemptorum: nova fecisti miracula: novum lumen ortum ex Virgine, quod tamen Deitati non erat novum, sed novum est insolito monstrato miraculo, novum regenerationis
%pp133
mysterium; in quo totum innovas mundum: nova genera virtutum in curatione \ae grorum: novum humilitatis ac patienti\ae \ modum in superbia persequentium: novum stupendumque genus virtutis in gloria resurgentis: nova humanis visibus tu\ae \ ostenditur majestatis potestas; cum verum hominem ad c\oe lorum sublimitatem deportas: Concede pro quibus tam nova miracula gloriosus opifex indidisti, hos \& vestigiorum tuorum sequaces, \& glori\ae \ facias coheredes; atque melodiam carminis, necnon inter Sanctorum fragores, \& nostras voces admisceas prestrepentes. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona 2. \color{black} Dominus in Sion magnus: \& excelsus super omnes populos. \color{Red} \hyperlink{ps98}{Psalmus 98.} \color{black}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} R}{}Edemptor noster Domine, qui super omnem altitudinem excelsus, \& in Sion agnosceris magnus; credulitatem Ecclesi\ae \ tu\ae \ in te amplians perfice; \& populos in ejus sinceritate fac coalescere: ut nomen tuum, quod magnum est, confitentes; ac regi\ae \ glori\ae \ honorem tibi, fidei servitute offerentes; tu nos miseratus de excelso prospice: \& ab hac humilitate terrarum in mansionibus commuta c\oe lorum. \R Amen. Per misericordiam tuam, Deus noster, \&c.
\newline \color{Red} Antiphona 3. \color{black} Dominus memor fuit nostri: \& benedixit nobis. \color{Red} \hyperlink{ps113}{Psalmus 113.} \color{black}
\newline \color{Red} Oratio. \color{black} Domine, qui sursum. \color{Red} Require fol. \color{black} \hyperlink{page.69}{69.}
\newline \R Hierusalem civitas sancta ultra non eget sole: quia claritas Dei illuminat eam. \P Splendor ejus agnus est. \V Turres Hierusalem auro \ae dificabuntur, \& propugnacula ejus auro mundo. \P Splendor. \V Gloria, \& honor Patri, \&c. \P Splendor.
\vspace{-.25em} \begin{center} \hypertarget{JEJUNIORUM-JANUARII-LAU-III}
IN LAUDIBUS.
\end{center}
\vspace{-.75em}
\bookmark[dest=JEJUNIORUM-JANUARII-LAU-III]{IN LAUDIBUS}
\par \noindent \color{Red} Antiphona. \color{black} Ne projicias nos, Domine, a facie tua: \& spiritum sanctum tuum ne auferas a nobis. \color{Red} \hyperlink{ps50}{Psalmus 50.} \color{black}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} N}{}E projicias nos Domine a facie tua; neque auferas misericordiam tuam a nobis: ut quos reatus facinorum tenet obnoxios, miserationis tu\ae \ clementia faciat absolutos. \R Amen. Per misericordiam tuam, Deus noster, \&c.
\vspace{-.5em} \begin{center} \color{Red} Ad Canticum. \color{black} \end{center} \vspace{-.5em}
\par \noindent \color{Red} Antiphona. \color{black} Splendor lucis illuminat eam, \& lucerna ejus agnus est.
\vspace{-.5em} \begin{center} \color{Red} Canticum Tobi\ae . \color{black} \itshape Capitulo \upshape 13. \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} L}{}Uce clara fulgebis in omnibus finibus terr\ae : * Nationes mult\ae \ de longinquo venient tibi, \& habitatores a novissimis partibus terr\ae \ ad nomen Domini Dei:
\newline {\color{Red} U}t munera sua in manibus habentes, regi c\oe lorum offerunt cum l\ae titia. * Et nomen Domini magnum erit in omnibus s\ae culis s\ae culorum.
\newline {\color{Red} M}aledicti omnes qui spernunt te, * \& omnes qui blasphemant te:
\newline {\color{Red} M}aledicti omnes qui oderunt te, * omnes qui dixerunt in te verbum durum:
\newline {\color{Red} M}aledicti omnes qui deponunt te, \& omnes qui destruunt muros tuos, * \& omnes qui subvertunt turres tuas, \& omnes qui succendunt habitationes tuas:
\newline {\color{Red} E}t benedicti erunt in te * omnes qui \ae dificant te, in \ae ternum.
\newline {\color{Red} T}unc gaude \& l\ae tare cum filiis justorum, * quia omnes colligentur, \& benedicent Dominum in \ae ternum.
\newline {\color{Red} F}elices qui diligunt te, * felices qui gaudent in pace tua.
\newline {\color{Red} E}t felices omnes homines qui contristabuntur in omnibus flagellis tuis, * quoniam gaudebunt, \& videbunt omne gaudium tuum in s\ae cula.
\newline {\color{Red} A}nima mea benedicet Dominum regem magnum, * quia liberavit Hierusalem,
\newline {\color{Red} E}t \ae dificabitur iterum domus ejus, * in omnibus s\ae culis s\ae culorum confitebitur nomini regis c\oe lorum.
\newline {\color{Red} O}stia Hierusalem smaragdo \& sapphiro fabricabuntur: * \& lapides pretiosi omnes muri tui,
\newline {\color{Red} T}urres Hierusalem auro \ae dificabuntur, * \& propugnacula ejus auro mundo.
\newline {\color{Red} P}late\ae \ Hierusalem canticum l\ae titi\ae \ dicunt, * \& omnis vicus ejus, Alleluia.
\newline {\color{Red} B}enedictus Dominus, qui exaltat te, \& benedictus in omnibus s\ae culis s\ae culorum: * quoniam in te benedicetur omne sanctum in \ae ternum.
\vspace{-.5em} \begin{center} \color{Red} Matutinarium. \color{black} \end{center} \vspace{-.5em}
\par \noindent \color{Red} Antiphona. \color{black} Emitte lucem tuam, Domine, \& veritatem tuam. \V Ipsa me deduxerunt, \& perduxerunt in monte sancto tuo. Gloria, \& honor Patri, \&c.
\newline \color{Red} Lauda. \color{black} Omnis spiritus laudet Dominum. \color{Red} \hyperlink{ps148}{Psalmus 148.} \color{black}
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Esai\ae \ Prophet\ae . \itshape Capitulo \upshape 48. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} H}{}\AE c dicit Dominus: Audite me h\ae c, domus Jacob, qui vocamini nomine Israel, \& de aquis Juda existis, qui juratis in nomine Domini Israel, recordamini non in veritate, neque in justitia. De civitate enim sancta vocati sunt, \& super Deum Israel constabiliti sunt: Dominus exercituum nomen ejus. Priora ex tunc adnuntiavi, \& ex ore meo
%pp134
exierunt, \& audita feci ea: repente operatus sum, \& venerunt. Scio enim quia durus es tu, \& nervus ferreus cervix tua, \& frons tua \ae rea. Pr\ae dixi tibi ex tunc: \& antequam venirent indicavi tibi, ne forte diceres: Idola mea fecerunt h\ae c, \& sculptilia mea, \& conflatilia mandaverunt ista. Qu\ae \ audistis, vide omnia: vos autem non adnuntiastis. Audita feci tibi nova ex tunc, \& conservata qu\ae \ nescis: nunc creata sunt, \& non ex tunc: \& ante diem, \& non vidisti ea, ne forte dicas: Ecce cognovi ea. Neque audisti, neque cognovisti, neque ex tunc aperta est auris tua: scio enim quia pr\ae varicans pr\ae varicabis, \& transgressorem ex ventre vocavi te. Propter nomen meum longe faciam furorem meum: \& laude mea infrenabo te, ne intereas. Ecce excoquam te, sed non quasi argentum, elegi te in camino paupertatis. Propter me faciam, ut non blasphemer: \& gloriam meam alteri non dabo. \R Amen.
\newline \color{Red} Hymnus. \color{black} Benignitatis fons.
\newline \color{Red} Supplicatio. \color{black} Oremus Redemptorem mundi.
\newline \color{Red} Capitula. \color{black} Dilectissimi fratres, qui omnia.
\newline \color{Red} Lauda. \color{black} Alleluia. L\ae tabitur deserta.
\newline \color{Red} Benedictio. \color{black} Christus Dominus, qui cum Patre. \color{Red} Require fol. \color{black} \hyperlink{page.66}{66.} \& \hyperlink{ps67}{67.}
\vspace{-.5em} \begin{center} \color{Red} \hypertarget{JEJUNIORUM-JANUARII-TER-III} Ad Tertiam. \color{black} \end{center} \vspace{-1em}
\bookmark[dest=JEJUNIORUM-JANUARII-TER-III]{AD TERTIAM}
\vspace{-.5em} \begin{center} {\color{Red} P}roverbiorum Salomonis. \itshape Capitulo \upshape 15. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} F}{}Ili, Labia sapientium disseminabunt scientiam: cor stultorum dissimile erit. Victim\ae \ impiorum abominabiles Domino: vota justorum placabilia. Abominatio est Domino via impii: qui sequitur justitiam, diligitur ab eo. Doctrina mala deserenti viam vit\ae : qui increpationes odit, morietur. Infernus, \& perditio coram Domino: quanto magis corda filiorum hominum? Non amat pestilens eum, qui se corripit: nec ad sapientes graditur. Cor sapientis exhilarat faciem: in m\oe rore animi dejicitur spiritus. Cor sapientis qu\ae rit doctrinam: \& os stultorum pascitur imperitia. Omnes dies pauperis, mali: secura mens quasi juge convivium. Melius est parum cum timore Domini, quam thesauri magni, \& insatiabiles. Melius est vocare ad olera cum charitate, quam ad vitulum saginatum cum odio. Vir iracundus provocat rixas: qui patiens est, mitigat excitatas. Iter impiorum quasi sepes spinarum: via justorum absque offendiculo. \R Amen.
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Deuteronomii. \itshape Capitulo \upshape 7. \& \ 8. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
...
\par {\color{Red} O}mne mandatum, quod pr\ae cipio tibi hodie, cave diligenter ut facias: ut possitis vivere, \& multiplicemini, ingressique possideatis terram, pro qua juravit Dominus patribus tuis. Et recordaberis cuncti itineris, per quod adduxit te Dominus Deus tuus quadraginta annis per desertum, ut affligeret te, atque tentaret, \& nota fierent qu\ae \ in tuo animo versabantur, utrum custodires mandata illius, an non. Afflixit te penuria: dedit tibi cibum Manna, quod ignorabas tu \& patres tui: ut ostenderet tibi quod non in solo pane vivet homo, sed in omni verbo quod egredietur ex ore Dei. \R Amen.
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Esai\ae \ Prophet\ae . \itshape Capitulo \upshape 30. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} E}{}Xpectat Dominus ut misereatur vestri: \& ideo exaltabitur parcens vobis: quia Deus judicii Dominus: beati omnes, qui expectant eum. Populus enim Sion habitabit in Hierusalem: plorans nequaquam plorabis, miserans miserebitur tui: ad vocem clamoris tui statim ut audierit, respondebit tibi. Et dabit tibi Dominus panem arctum, \& aquam brevem: \& non faciet avolare a te ultra doctorem tuum: \& erunt oculi tui videntes pr\ae ceptorem tuum. Et aures tu\ae \ audient verbum post tergum monentis: H\ae c via, ambulate in ea: neque ad dexteram, neque declinetis ad sinistram. Et contaminabis laminas sculptilium argenti tui, \& vestimentum conflatilis auri tui, \& disperges ea sicut immunditiam menstruat\ae . Egredere, dices ei: Et dabitur pluvia semini tuo, ubicumque seminaveris in terra: \& panis frugum terr\ae \ erit uberrimus, \& pinguis: pascentur in possessione tua in die illa agnus
%pp135
spatiose: \& tauri tui, \& pulli asinorum, qui operantur terram, commistum migma comedent, sicut in area ut ventilatum est. Et erunt super omnem montem excelsum, \& super omnem collem elevatum rivi currentium aquarum, in die interfectionis multorum cum ceciderit turris. Et erit lux lun\ae \ sicut lux solis, \& lux solis erit septempliciter sicut lux septem dierum, in die qua alligaverit Dominus vulnus populi sui, \& percussuram plag\ae \ ejus sanaverit. \R Amen.
\vspace{-.5em} \begin{center} {\color{Red} S}equentia Epistol\ae \ Pauli Apostoli ad Ephesios. \itshape Capitulo \upshape 5. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} F}{}Ratres, Estote imitatores Dei, sicut filii charissimi: \& ambulate in dilectione, sicut \& Christus dilexit nos, \& tradidit semetipsum pro nobis oblationem, \& hostiam Deo in odorem suavitatis. Fornicatio autem, \& omnis immunditia, aut avaritia nec nominetur inter vos, sicut decet sanctos: aut turpitudo, aut stultiloquium, aut scurrilitas, qu\ae \ ad rem non pertinet; sed magis gratiarum actio. Hoc enim scitote intelligentes: quod omnis fornicator, aut impudicus, aut immundus, aut avarus, quod est idolorum servitus, non habet hereditatem in regno Christi, \& Dei. Nemo vos seducat inanibus verbis: propter hoc enim venit ira Dei in filios diffidenti\ae . Nolite ergo effici participes eorum. Eratis autem aliquando tenebr\ae : nunc autem lux in Domino. Ut filii lucis ambulate: fructus enim lucis est in omni bonitate, \& justitia, \& veritate: probantes quid sit beneplacitum Domino: \& nolite communicare operibus infructuosis tenebrarum, magis autem \& redarguite. Qu\ae \ enim inocculto fiunt ab ipsis, turpe est dicere. Omnia autem, qu\ae \ arguuntur, a lumine manifestantur: omne autem, quod manifestatur, lumen est. Propter quod dicit: Surge qui dormis, exurge a mortuis, \& illuminabit te Christus. \R Amen.
\newline \color{Red} Antiphona 1. \color{black} Magnus Dominus noster: \& terribilis super omnes deos. Quia omnes dii Gentium d\ae monia: Dominus autem c\oe los fecit. \color{Red} \hyperlink{ps95}{Psalmus 95.} \color{black}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine, qui es supra omnes gentes excelsus, \& in c\oe lestibus habitas gloriosus; humilitatem nostram ab excelso intende placatus; ac sicut Ecclesia tua, qu\ae \ erat sterilitatis vitio impedita, nunc est, in te credens, virtutum meritis plena, \& filiis numerosa; ita mens nostra, ab sterilitate operum infecunda, te tribuente possit \& semen verbi suscipere, \& copiosis fructibus redundare: nomenque tuum, a solis ortu usque ad occasum pr\ae clarum, cordis ambiat unanimitate diligere, \& fidei assentione laudare. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona 2. \color{black} Servite Domino Deo vestro: \& nolite adorare deos alienos; quia Dominus sanctus est. Exultate Deo adjutori nostro: jubilate Deo Jacob. \color{Red} \hyperlink{ps80}{Psalmus 80.} \color{black}
\newline \color{Red} Oratio. \color{black} Tibi adjutori nostro Domino exultatione fidei. \color{Red} Require fol. \color{black} \hyperlink{page.69}{69.}
\newline \color{Red} Antiphona 3. \color{black} In toto corde vestro convertimini ad Deum, \& auferte deos alienos de medio vestri, \& servite Domino soli, \& liberabit vos de manu inimicorum vestrorum. Audite h\ae c omnes Gentes: auribus percipite, qui habitatis orbem. \color{Red} \hyperlink{ps48}{Psalmus 48.} \color{black}
\newline \R Apparuit claritas Dei in nube. \P Sicut in temporibus Moysi. Et manifestabitur quemadmodum Salomon deprecatus orabat. \V Manifestatus est Dominus, quoniam habitavit in excelso: implevit Sion judicio, \& justitia: \& erit fides in temporibus suis. \P Sicut in temporibus. \V Gloria, \& honor, \&c. \P Sicut.
\newline \color{Red} Preces. \color{black} Clamamus ad te, Deus, exaudi nos. \P Et a flagello ir\ae \ tu\ae \ libera. \V Contritos fove, \& humiliatos tuere, elisos erige, deprecantibus miserere. \P Et a flagello. \V Deus excelse, clamorem nostrum attende, peccata dimitte, \& pluviam cito largire. \P Et a flagello. \V Exaudi flentes, \& consolare lugentes: gaudium captivis, \& patriam redde peregrinis. \P Et a flagello.
\vspace{-.5em} \begin{center} \color{Red} Supplicatio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} O}{}Remus Auctorem lucis Dominum nostrum Jesum Christum, cum omni supplicatione rogemus; ut nos claritate sua propitius inlustrare dignetur. \R Pr\ae sta \ae terne omnipotens Deus.
\vspace{-.5em} \begin{center} \color{Red} Capitula. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} A}{}Periat, qu\ae sumus, Domine os nostrum sapientia; \& corde meditemur, \& lingua loquamur prudentiam: \& ne jumentis insipientibus comparemur, disciplinis divin\ae \ legis erudiamur: ut te solummodo intelligentia nostra adsequens ambiat, quem \ae terno in gaudio cum Sanctis omnibus laudans, pr\ae mia sempiterna suscipiat.
\par Pater noster, \&c,
\par \color{Red} Ad Sextam, omnia dicantur ut in Sexta, qu\ae \ dicitur per totum annum. \color{black}
\par \color{Red} Ad Nonam, dicantur ut in secundo die pr\ae terito jejuniorum. \color{black}
\end{multicols}
...
\fancyhead[RO]{\small\rightmark\hspace{1cm}\thepage}
\fancyhead[LE]{\small\thepage\hspace{1cm}\leftmark}
\begin{center} \color{Red} \fontsize{32}{28}\selectfont \bfseries \hypertarget{APPARITIONIS}
IN FESTO\\ \vspace{+.25em}
\color{black} \Huge APPARITIONIS DOMINI.
\end{center}
\vspace{-1.5em}
\bookmark[rellevel=-2,dest=APPARITIONIS]{EPIPHANI\AE \ DOMINI}

\begin{multicols*}{2}
\begin{center} \color{Red} \hypertarget{APPARITIONIS-VES}{\label{APPARITIONIS-VES}}
AD VESPEROS.
\end{center}
\vspace{-.75em}
\bookmark[rellevel=1,dest=APPARITIONIS-VES]{IN APPARITIONIS DOMINI NOSTRI JESU CHRISTI}
\bookmark[rellevel=1,dest=APPARITIONIS-VES]{AD VESPEROS}
\par \noindent \color{Red} Lauda. \color{black} Qui fecit solem \P In splendorem diei: lunam, \& stellas in luminare noctis. \V Qui turbat mare, \& resonat fluctus ejus, Dominus omnipotens nomen est ei. \P In splendorem diei.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine, apud quem est fons vit\ae , \& in cujus lumine aspicimus lumen; enutri in nos tu\ae \ scienti\ae \ splendorem: ut sitientibus nobis vitalem impartias potum; \& caligantium animarum superno lumine restituas intellectum. \R Amen. Per misericordiam tuam.
\newline \color{Red} Sono. \color{black} Ante solem permanet nomen ejus, \& ante lunam sedes ejus: \& benedicentur in eo omnes tribus terr\ae . Alleluia. \V Orietur in diebus ejus justitia, \& abundantia pacis: donec extollatur luna. Et dominabitur a mari usque ad mare; \& a fluminibus usque ad fines terr\ae . Coram illo \AE thiopes procident. Alleluia. Dominus sit semper. \R Et cum.
\newline \color{Red} Antiphona. \color{black} Rex magnus apparuit in Israel, \& venerunt reges terr\ae , \P Adorare eum: \& obtulerunt ei munera aurum, thus, \& myrrham. \V Quoniam ecce reges terr\ae \ congregati sunt, \& convenerunt in unum. \P Adorare eum: \& obtulerunt. \V Gloria, \& honor Patri, \&c. \P Adorare eum: \& obtulerunt.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine Jesu Christe, qui Magorum munera, in mysterio oblata, Deum te, regemque, hominemque declarant: ut primitias Gentium in his acceptares, plenitudinem Gentium in salutare perficiens; adesto nobis per ea, qu\ae \ in te divisa, inconfusa constare veraciter credimus: dum pro nobis \& ut homo innocens pateris, \& ut rex potens vincis, \& ut Deus omnipotens incorruptibilis permanes; cujus utique \& Passioni myrrha, \& Regno aurum, \& Deitati debetur incensum. \R Amen. Per misericordiam.
\newline \color{Red} Antiphona. \color{black} Germinaverunt campi eremi germen floris Israel; \P Quia venit rex Dominus cum l\ae titia in lumine majestatis su\ae : ut adorent eum. \V L\ae tentur c\oe li, \& exultet terra, commoveatur mare, \& plenitudo ejus. \P Quia venit rex. \V Gloria, \& honor, \&c. \P Quia. Dominus sit semper. \R Et cum.
\newline \color{Red} Lauda. \color{black} Adorent eum omnes Angeli ejus, Alleluia: \P Audivit, \& l\ae tata est Sion. Alleluia, alleluia. \V Dominus regnavit, exultet terra: l\ae tentur insul\ae \ mult\ae . \P Audivit, \& l\ae tata est. \V Gloria, \& honor Patri, \& Filio, \&c. \P Audivit, \& l\ae tata est.
\vspace{-.5em} \begin{center} \color{Red} Hymnus. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} I}{}Nluminans Altissimum
\newline Micantium astrorum globum.
\newline \indent Pax, vita, lumen, veritas.
\newline \indent Jesu, fave precantibus:
\newline {\color{Red} S}ed mystico baptismate
\newline \indent Fluenta Jordanis, retro
\newline \indent Conversa quodam tempore,
\newline \indent Præsenti sacravit die.
\newline {\color{Red} S}eu stella partum Virginis
\newline \indent C\oe lo micans signaverit.
\newline \indent Et hic adoratus die,
\newline \indent Præsepe Magos duxerit.
\newline {\color{Red} V}el hydriis plenis aquæ
\newline \indent Vini saporem infuderit,
\newline \indent Hausit minister conscius,
\newline \indent Quod ipse non impleverat.
\newline {\color{Red} A}quas colorari videns
\newline \indent Inebriari flumina
\newline \indent Mutata elementa stupent
\newline \indent Transire usus alteros:
\newline {\color{Red} S}ic quinque millibus viris
\newline \indent Dum quinque panes dividunt,
\newline \indent Edentium sub dentibus
\newline \indent In ore crescebat cibus
\newline {\color{Red} M}ultiplicabatur magis
\newline \indent Dispendio panis suo,
\newline \indent Qui hæc videns mirabatur
\newline \indent Juges meatus fontium.
\newline {\color{Red} I}nter manus frangentium
\newline \indent Panis rigatur profluus,
\newline \indent Intacta, quæ non fregerant
\newline \indent Fragmentis subrepunt viri.
\newline {\color{Red} M}emento salutis Auctor, \&c.
\newline \indent Gloria tibi, Domine, \&c.
\vspace{-.5em} \begin{center} \color{Red} Supplicatio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} O}{}Remus Auctorem lucis Dominum nostrum Jesum Christum, cum omni supplicatione rogemus: ut nos lumine claritatis su\ae \ propitius illuminare \& illustrare
%pp138
dignetur.
\R Pr\ae sta \ae terne omnipotens Deus. Kyrie, eleison. \R Christe, eleison. Kyrie, eleison.
\vspace{-.5em} \begin{center} \color{Red} Capitula. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} A}{}Lpha \& Omega initium \& finis, Deus \& homo, infinitus \& pr\ae finitus: in quo \& principium Deitas, \& ultimum sentitur Humanitas: excedens omnia; vivificans cuncta, \& continens universa; miserere nobis, quia dignatus es nasci pro nobis dum in te permanes, \& nobis appares: dum in te subsistis, \& nobis subvenis: dum nusquam a Patre potentialiter dees, \& ad salvandos miseros clementialiter ades: dum c\oe lestia reples, \& terrena non deseris; perfice in nobis, qu\ae sumus, beneficia piissimi Redemptoris, dum conservas gloriam in\ae stimabilis Conditoris: ut pietate, qua redemptor adsistis, indultor quoque criminum sentiaris.
\par Pater noster. Liberati a malo. \color{Red} fol. \color{black} \hyperlink{page.2}{2.} Humiliate vos benedictioni. Dominus sit semper. \R Et cum.
\vspace{-.5em} \begin{center} \color{Red} Benedictio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} B}{}Eenedicat vobis Alpha \& Omega cognominatus Omnipotentis Dei Patris Unigenitus Filius. \R Amen. Qui est initium \& finis: ipse nos secum victuros attollat temporibus infinitis. \R Amen. Atque, ereptos a malis, ita illustret lumine claritatis, ut vos \& glori\ae \ pr\ae miis, \& donis ditet \ae ternitatis. \R Amen. Per misericordiam ipsius.
\newline \color{Red} Lauda. \color{black} Misit me sanare contribulatos corde, Alleluia; \P Pr\ae dicare captivis redemptionem, \& c\ae cis reddere lumen. Alleluia, alleluia. \V Redemptionem misit Dominus populo suo: mandavit in \ae ternum testamentum suum. \P Pr\ae dicare captivis. \V Gloria, \& honor patri, \&c. \P Pr\ae dicare captivis.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine Deus, qui adventum Unigeniti Filii tui Johannem puerum pr\ae currere voluisti; ut missus a te viam Christo incredulorum cordibus pr\ae pararet, sanando contribulatos corde, \& c\ae cis restituendo luminis claritatem: suffragio ejus \& c\ae citatem cordis illumina, \& tribulationes cordium nostrorum in \ae ternum gaudium muta; ut qui nativitatem Unigeniti Filii tui gaudio christiano attollimur, in adventu judicii ejus nullis p\oe narum vinculis contristemur. \R Amen. Per misericordiam tuam.
\newline \color{Red} Dicat Presbyter. \color{black} Dominus sit semper vobiscum. \R Et cum. In nomine Domini.
\vspace{-.5em} \begin{center} \color{Red} \hypertarget{APPARITIONIS-MAT} Ad Matutinum. \color{black} \end{center} \vspace{-.5em}
\bookmark[dest=APPARITIONIS-MAT]{AD MATUTINUM}
\par \noindent \color{Red} Antiphona. \color{black} Domini est salus: \& super populum tuum benedictio tua. \color{Red} \hyperlink{ps3}{Psalmus 3.} \color{black}
\newline \color{Red} Oratio. \color{black} Tu es, Domine, salus. \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.44}{44.}
\newline \color{Red} Antiphona 1. \color{black} Hierusalem in te apparebit Dominus; \P Et honor ejus super te videbitur. Et ibunt reges in lumine tuo, \& Gentes in splendore tuo ambulabunt. \V Et permanebit cum sole, \& ante lunam, in generatione \& in s\ae culum s\ae culi. \P Et honor ejus. \V Gloria, \& honor, \&c. \P Et honor ejus.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} F}{}Ac nos, Domine, beat\ae \ illius Hierusalem visione l\ae tari, \& in gremio ejus perpetua jocunditate attolli, in qua tu lux \ae terna, radiare promittis, \& cujus honor esse polliceris: Largire ergo nobis, ejus desiderio carnalibus exui nugis \& vestiri virtutibus copiosis: ut eam, cui tu apparendo factus es indeficiens lumen, nos amplectamur semper meritis genitricem. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona 2. \color{black} Gloriosus est aspectus ejus, \& inter filios hominum forma ejus. \P Ante eum continuerunt reges os suum. Quibus non est nuntiatum de eo, adoraverunt eum. \V Coram illo procident \AE thiopes: \& inimici ejus terram lingent. \P Ante eum continuerunt. \V Gloria, \& honor Patri, \&c. \P Ante eum.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus, Dei Filius, cujus inter homines \& forma \& aspectus est gloriosus, glorificandos nos tibi adsume, \& in partis dexter\ae \ coronandos conlocatione statue, ut qui ora nostra in tuis laudibus aperimus, carnis sensibus non gravemur: \& qui gloriosi aspectus tui solamen exquirimus, visionis tu\ae \ consolatione omnimoda potiamur. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona 3. \color{black} In diebus Herodis regis ecce Magi ab Oriente venerunt Hierosolymam, \P Dicentes: Ubi est, qui natus est Rex Jud\ae orum? vidimus enim stellam ejus in Oriente, \& venimus adorare eum. \V Quoniam ecce reges terr\ae \ congregati sunt, \& convenerunt in unum. \P Dicentes: Ubi est. \V Gloria, \& honor Patri, \&c. \P Dicentes: Ubi est.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} R}{}Ex omnium s\ae culorum, Christe Deus altissime, qui in diebus Herodis regis de Virgine natus, Magis, qu\ae rentibus te, novo es in sidere declaratus; appareat in nobis virtutis tu\ae \ pr\ae sidium ad depellendas omnes pernicies tenebrarum, quo sic Majestatis
%pp139
tu\ae \ sidus in nobis resplendeat, ut ad te qu\ae rendum nulli se nobis errorum obices interponant, quo \& ad te videndum curramus alacriter, \& te viso jocundemur instanter. \R Amen. Per misericordiam tuam.
\newline \R Hierusalem ecce apparuit in te rex regum, \& commovebuntur insul\ae \ de locis suis. Omnes principes Gentium descendent de thronis suis, \& afferent diadema de capite suo. \P Et offerent ei de lapidibus pretiosis aurum, thus, \& myrrham. \V Ecce reges terr\ae \ congregati sunt, \& convenerunt in unum, \P Et offerent. \V Reges Tharsis, \& insul\ae \ munera offerent: reges Arabum \& Saba dona Deo adducent. \P Aurum. \V Gloria, \& honor Patri, \&c. \P Hierusalem.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus, Dei Filius, Patris ineffabilis virtus, qui novo sidere in Gentibus rex regum ostenderis magnus, \& in civitate illa beata appares gloriosus: quem insul\ae \ tremunt: cui principes \& nationes Gentium obsequuntur, dum tibi omnia regna cedunt, tibi regum diademata substernuntur; dignare jam gratia, nostris te ostendere sensibus pium, \& in conversationibus manifestum: ut primitias spiritus habentes, ea tibi semper per munera dedicemus, per qu\ae \ introire beatam illam Hierusalem placitis cordibus mereamur, ut tibi mundissimum aurum nostrorum operum deferentes, regni tui mereamur esse participes. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona. \color{black} Reges Tharsis, \& insul\ae \ munera offerunt: reges Arabum \& Saba dona adducent. \P Et adorabunt in conspectu ejus omnes reges terr\ae : omnes Gentes serviunt illi: Quoniam ipse liberavit egenum a potente; \& pauperem, cui non erat adjutor. \V Ex usuris \& iniquitate liberavit animas eorum, \& pr\ae clarum nomen eorum coram illo. \P Et adorabunt. \R Gloria, \&c. \P Et adorabunt.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine Jesu Christe, cui reges \& insul\ae \ munera offerunt; qui invicta virtute liberare venisti pauperem a potente; \& ex hostis antiqui potentia fragile humanum genus eripere miseratione superna: cum nos a te prolongati, tuarumque miserationum inopes facti; illius iniquitati subditi, vinculisque peccaminum teneremur addicti: Sic tua nos jam pietas \& ab ejus s\ae vitia eruat, \& restitutos tibi, tecum permansuros commendet: ut qui nos te miserante redemptos fatemur; remuneraturi te donante postmodum gloriemur. \R Amen. Per misericordiam.
\newline \color{Red} Antiphona. \color{black} Domine, qui te nutriunt, reges erunt \& regin\ae \ nutrices tu\ae . \P Vultu in terra inclinato adorabunt te, \& pulverem pedum tuorum lingent, \& cognosceris Dominus, in quo non confundentur omnes, qui te expectant. \V Natio, \& progenies collaudabunt opera tua, \& potentiam tuam pronuntiabunt. \P Vultu in terra. \V Gloria, \& honor Patri, \&c. \P Vultu in terra.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine, quem inclinato in terram plebes vultu adorant, dum tuo subjiciuntur imperio universa; largire indefessam populis Christianis l\ae titiam, \& hodiern\ae \ Apparitionis tu\ae \ gaudia protende in Gentibus dedicanda; nobis quoque ita esto semper placabilis, ut propitius in judicio sentiaris, quo vit\ae \ nostr\ae \ ex vultu tuo tam indesinens solamen existat, ut a te nostrorum nullus depereat, qui te unum \& verum Deum expectat. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona. \color{black} Interrogabat Magos Herodes: Quod signum vidistis super natum regem? \P Stellam vidimus fulgentem, \& venimus adorare Deum. \V Omnes Gentes plaudite manibus: jubilate Deo in voce exultationis. \P Stellam vidimus. \V Gloria, \& honor Patri, \&c. \P Stellam vidimus.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine Jesu Christe, qui ad interrogationem Herodis ita Magorum ora pr\ae conio veritatis tu\ae \ irradias, ut te regem regum per eos nuntiatum ostendas; dum se vidisse ajunt stell\ae \ refulgentis indicium, quod mundum illuminet universum; te qu\ae sumus, te precamur, ut des in Ecclesia tua visionis tu\ae \ lumen optatum: appareas etiam in ea sidus omnibus pretiosum, quod nulla adversarii interrogatione deterriti, sic magnalia tua pr\ae dicemus ore diffuso, ut in \ae tern\ae \ lucis radiemur usquequaque pr\ae sidio. \R Amen. Per misericordiam.
\newline \R Apparuit vir in majestate sua circumdatus fulgore, \& a claritate adventus Domini illuminabitur terra, \& erit l\ae titia, \& gaudium omni populo. \P Ita, \& reges, principesque venient, \& adorabunt eum. \V Regnum ejus regnum sempiternum, \& usque ad antiquum dierum pervenit; \& data est ei omnis potestas. \P Ita, \& reges. \V Gloria, \& honor Patri, \&c. \P Ita, \& reges.
%pp140
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus, qui brevissimum sidus voluisti gratia repentini vestire fulgoris; ostende, qu\ae sumus, faciem tuam populis Christianis: ut, sicut Magis errantibus tandem tramitem veri demonstrasti itineris, ita nobis delinquentibus tribuas portum \ae tern\ae \ salutis. \R Amen. Per misericordiam.
\newline \color{Red} Antiphona. \color{black} Viri sublimes ad te transibunt, \& tui erunt: te adorabunt, teque deprecabuntur: Tantum in te est Deus, \& non est pr\ae ter te. \P Vere tu es Deus absconditus, Deus Israel Salvator. \V Domine Deus virtutum quis similis tibi? Potens es Domine, \& veritas tua in circumitu tuo. \P Vere tu es Deus. \V Gloria, \& honor, \&c. \P Vere.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} A}{}Dorabunt te, Domine Jesu Christe, omnes viri sublimes atque excelsi terr\ae , quoniam ipse, ut salvares homines, humilis nasci dignatus es in terris; in te enim vere Deus est, quia tu verbum in carne absconditum, non mutatum, unum cum Patre possides nomen; confundantur proinde omnes, qui adversantur tibi: dum aut sic erubescunt, ut ad te redeant: aut in te confundantur, si ad te minime convertantur; noster ergo Salvator salvandis nobis appareas, dum nos in te credere, \& ad te transire, \& te toto corde diligere pr\ae stas. \R Amen. Per misericordiam. Et tu es Deus benedictus, \& gloriosus in s\ae cula s\ae culorum. \R Amen.
\newline \color{Red} Antiphona. \color{black} Erit lumen lun\ae \ sicut lumen solis, \& lux solis erit septempliciter sicut lux septem dierum. \P In die qua alligaverit Dominus vulnus populi sui, \& percussuram plag\ae \ ejus sanaverit: Ecce enim Dominus cum l\ae titia venit. \V Et timebunt Gentes nomen tuum Domine, \& omnes reges terr\ae \ gloriam tuam. \P In die qua. \V Gloria, \& honor, \&c. \P In die qua.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus, qui ligare venturus es vulnus populi tui, percussuram plag\ae \ nostr\ae \ sanaturus, adesto: ut ita quicquid in nobis est vitiosum, vel lubricum, divinitatis tu\ae \ luce illumines, ut nec per noctem hujus s\ae culi luna nos concremet, nec per diem futuri examinis sol veritatis exurendos tristificet. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona. \color{black} Ecce stella, quam viderant Magi ab oriente, antecedebat eos, donec veniret supra, ubi erat puer. \P Videntes autem Magi stellam, gavisi sunt gaudio magno. \V Ipsi videntes sic admirati sunt, conturbati sunt, \& commota sunt omnia viscera eorum. \P Videntes autem. \V Gloria, \& honor, \&c. \P Videntes.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} S}{}Tella illa, Domine, qu\ae \ natum te in terris regem Magis stupentibus nuntiavit, non sidereas in c\oe lum vias tenuit, cum novo Virginis partu novum sidus apparuit, sed ad demonstrandum te hominibus Christum usque ad ipsum nativitatis tu\ae \ loculum pr\ae cucurrit; unde profusis precibus te imploramus, ut, qui ejus indicio absque errore Magorum direxisti itinera, nostra, te apparente, sanctifices corda: ut in \ae quitate coram te gradientes atque justitia, pervenire mereamur ad gaudia repromissa. \R Amen. Deducente nos gratia dexter\ae \ tu\ae , Domine Jesu Christe; qui cum Patre, \& Spiritu Sancto vivis, \& omnia regis in s\ae cula s\ae culorum. Dominus sit semper. \R Et cum.
\newline \R Luce clara fulgebis in omnibus finibus terr\ae . Nationes mult\ae \ de longinquo venient tibi, \& habitatores a novissimis partibus terr\ae \ in manibus habentes munera. \P Regi c\oe lorum offerunt cum l\ae titia: \& nomen Domini magnum erit in omnia s\ae cula. \V Omnes de Saba venient, aurum \& thus deferentes, \& laudem Domino annuntiantes. \P Regi c\oe lorum. \V Gloria, \& honor, \&c. \P Regi c\oe lorum.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} A}{}Bundet, qu\ae sumus Domine, in diebus nostris lux claritatis tu\ae \ in finibus terr\ae : ut, quos Apparitionis tu\ae \ luce irradias, abundantia pacis usquequaque sustollas: ut, dum deputatis officiis obsequii dependimus votum, \ae there\ae \ lucis luminosum capiamus effectum. \R Amen. Per misericordiam.
\newline \color{Red} Antiphona. \color{black} Signum magnum visum est in c\oe lo: Mulier amicta erat sole, \& luna sub pedibus ejus, \& super caput ejus corona stellarum duodecim. Et festinabat, ut pareret; \& peperit filium. \P Qui recturus est omnes gentes in virga ferrea. \V In sole posuit tabernaculum suum: \& ipse tamquam sponsus procedens de thalamo suo. \P Qui recturus est. \V Gloria, \& honor, \&c. \P Qui recturus est.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus sanctificator diei hodiern\ae , qui sanct\ae \ hujus festivitatis nomen de mirabilibus indidisti; da Ecclesi\ae \ tu\ae , ut sicut Epiphania, id est hodierna solemnitas, \&
%pp141
declaratio \& apparitio nuncupatur: ita in populo tuo claritas Majestatis tu\ae \ fulgescat, \& sanctitatis lumen appareat, ut plebs h\ae c, in tuo nomine consecrata, hoc habeat jugiter in conversatione, quod h\ae c festivitas appellatur ex nomine. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona. \color{black} Ecce odor filii mei sicut odor agri pleni, cui benedixit Dominus. Det tibi Deus de rore c\oe li, \& de pinguedine terr\ae . \P Ut serviant tibi Gentes, \& adorent te tribus. \V Pete a me, \& dabo tibi Gentes hereditatem tuam, \& possessionem terminos terr\ae . \P Ut serviant tibi Gentes, \& adorent. \V Gloria, \& honor, \&c. \P Ut serviant.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} G}{}Loriose Deus Pater \& Domine, qui Unigenito \& co\ae terno filio tuo servire Gentes \& adorare tribus dedisti: poscimus, tua ipsi possessio simus; ut ab ejus filii tui non deviemus pr\ae ceptis, ut ei nos indivise connectes, quem ex te genitum gloriose pronuntias. \R Amen. Quia tecum summe Pater \& cum Spiritu Sancto unus est Deus in s\ae cula s\ae culorum. Dominus sit. \R Et cum.
\newline \color{Red} Antiphona. \color{black} Dixit auditor sermonum Domini, qui visionem Omnipotentis intuitus est. \P Videbo eum, sed non modo: intuebor illum, sed non prope. Orietur stella ex Jacob \& consurget homo de Israel. \V Magnus Dominus noster, \& magna virtus ejus: \& sapienti\ae \ ejus non est numerus. \P Videbo eum. \V Gloria, \& honor, \&c. \P Videbo.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} T}{}U es Domine stella veritatis oriens ex Jacob, homoque consurgens ex Israel: \& in novo sidere ostenderis Deus, \& in pr\ae sepio positus Deus \& homo, unus crederis Christus; propter magnam misericordiam tuam visionis tu\ae \ nobis proroga gratiam: appareat in nobis lucis tu\ae \ radiabile signum, quod expellat omnes tenebras vitiorum: ut, qui visionis tu\ae \ desiderio anhelamus, visionis tu\ae \ pr\ae mio consolemur. \R Amen. Per misericordiam tuam.
\newline \R Fulget C\oe lum, \& Terra splendet a claritate Dei, quia processit de habitaculo sancto suo sanare contribulatos corde, \& c\ae cis reddere lumen. \P Gaudete hodie univers\ae \ Gentes, quia in medio vestri Salvator apparuit: jam nolite pavere. \V Illuxit enim gratia Dei Salvatoris nostri in omnibus hominibus. \P Gaudete hodie. \V Gloria, \& honor, \&c. \P Gaudete hodie.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} F}{}Ulget, Domine, C\oe lum rutilum serenitate astrorum, Terraque ipsa refulgenti lumine serenatur, quia apparere dignatus es mundo de habitaculo sancto tuo; sana ergo cordis nostri m\oe stitiam, quia ad hoc venisti, ut redimas universa: illudque nostris oculis lumen attribue, quo te purificati semper mereamur aspicere: ut qui Apparitionis tu\ae \ gaudia l\ae tabunda nuntiamus in Gentibus, infinita tecum l\ae titia gaudeamus. \R Amen. Per misericordiam tuam.
\newline \color{Red} Antiphona. \color{black} Ego sum Alpha, \& Omega, primus, \& novissimus: principium \& finis. \P Ego sum radix, \& genus David, stella splendida, \& matutina. Sponsus, \& sponsa dicunt: Veni. Et qui sitit, veniat: \& accipiat aquam vit\ae , gratis. \V Deus deorum Dominus locutus est, \& vocavit terram. \P Ego sum. \V Gloria, \&c. \P Ego sum Alpha, \& Omega.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} A}{}Lpha, \& Omega, principium, \& finis, radix, \& genus, filius, Dominusque David, Christus Deus \& homo, per quem utique est ille, ex quo esse dignatus es; esto nobis propitius, dum nos \& ut David Dominus regis, \& ut humilis misericors redimis: ut sceptro tuo subjiciens devotionem nostram, solus nos possideas in \ae ternum, qui solus victor factus es infernorum. \R Amen. Et permanes Deus benedictus in omnia s\ae cula s\ae culorum. \R Amen. Dominus sit. \R Et cum.
\vspace{-.5em} \begin{center} \hypertarget{APPARITIONIS-LAU} IN LAUDIBUS.\\ \color{Red} Ad Canticum. \end{center} \vspace{-.5em}
\bookmark[dest=APPARITIONIS-LAU]{IN LAUDIBUS}
\par \noindent \color{Red} Antiphona. \color{black} Benedictus es Domine Deus Israel, quia visitasti nos, \& fecisti redemptionem plebis tu\ae .
\vspace{-.5em} \begin{center} \color{Red} Canticum. Zachari\ae . \color{black} \itshape Capitulo \upshape 1. \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} E}{}T erexit cornu salutis nobis, * in domo David pueri sui.
\newline {\color{Red} S}icut locutus est per os sanctorum, * qui a s\ae culo sunt, prophetarum ejus:
\newline {\color{Red} S}alutem ex inimicis nostris, * \& de manu omnium odio qui oderunt nos:
\newline {\color{Red} A}d faciendam misericordiam cum patribus nostris: * \& memorari testamenti sui sancti.
\newline {\color{Red} J}usjurandum, quod juravit ad Abraham patrem nostrum, * daturum se nobis:
\newline {\color{Red} U}t sine timore, de manu inimicorum nostrorum * liberati, serviamus illi;
\newline {\color{Red} I}n sanctitate \& justitia coram ipso, * omnibus diebus nostris.
\newline {\color{Red} E}t tu puer, propheta Altissimi vocaberis: *
%pp142
pr\ae ibis enim ante faciem Domini parare vias ejus:
\newline {\color{Red} A}d dandam scientiam salutis plebi ejus, * in remissionem peccatorum eorum:
\newline {\color{Red} P}er viscera misericordi\ae \ Dei nostri: * in quibus visitavit nos, oriens ex alto
\newline {\color{Red} I}lluminare his, qui in tenebris, \& umbra mortis sedent: * ad dirigendos pedes nostros in viam pacis.
\newline \color{Red} Antiphona. \color{black} Benedictus es Domine Deus Israel. Gloria, \& honor, \&c. \P Quia visitavit nos.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus Omnipotens, cujus continuo filii efficimur, dum tinctione salutaris aqu\ae \ purgamur; fac nos ita benedictionis tu\ae \ percipere donum, ut merito supern\ae \ civitatis Hierusalem filii appellemur: ut, qui Gentibus es manifestatus in sidere, credentibus appareas in salutem; \&, qui nos renovasti benedictionis aqua per lavacrum, renoves in futuro per indult\ae \ grati\ae \ repromissum. \R Amen. Per misericordiam tuam.
\vspace{-.5em} \begin{center} \color{Red} Ad aliud Canticum. \end{center} \vspace{-.5em}
\par \noindent \color{Red} Antiphona. \color{black} Adest lumen tuum Hierusalem, \& majestas Domini in te videbitur.
\vspace{-.5em} \begin{center} \color{Red} Canticum Esai\ae . \color{black} \itshape Capitulo \upshape 60. \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} S}{}Urge, illuminare Hierusalem: * quia venit lumen tuum, \& gloria Domini super te orta est.
\newline {\color{Red} Q}uia ecce tenebr\ae \ operient terram, * \& caligo populos:
\newline {\color{Red} S}uper te autem orietur Dominus, * \& gloria ejus in te videbitur.
\newline {\color{Red} E}t ambulabunt Gentes in lumine tuo, * \& reges in splendore ortus tui.
\newline {\color{Red} L}eva in circumitu oculos tuos, \& vide: * omnes isti congregati sunt, venerunt tibi:
\newline {\color{Red} F}ilii tui de longe venient, * \& fili\ae \ tu\ae \ de latere surgent.
\newline {\color{Red} T}unc videbis, \& afflues, * \& mirabitur \& dilatabitur cor tuum,
\newline {\color{Red} Q}uando conversa fuerit ad te multitudo maris, * fortitudo Gentium venerit tibi.
\newline {\color{Red} A}dest lumen tuum, Hierusalem, * \& majestas Domini in te videbitur.
\newline  \color{Red} Reiteretur Antiphona. \color{black} Adest lumen tuum.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} C}{}Hriste, Filius Dei, qui pr\ae cessione radiantis stell\ae \ teipsum in pr\ae sepio positum Magis te qu\ae rentibus voluisti ostendere; pr\ae cedente nos, vel subsequente gratia tua, \ae ternum nobis sidus refulgeat, quo te quotidie inveniamus edendum, qui cibus factus es redemptorum. \R Amen. Per misericordiam tuam.
\vspace{-.5em} \begin{center} \color{Red} Ad Benedictus. \end{center} \vspace{-.5em}
\par \noindent \color{Red} Antiphona. \color{black} Tibi soli Deo, honor, \& gloria, virtus, \& potestas in s\ae cula s\ae culorum.
\newline \color{Red} Canticum. \color{black} Benedictus es Domine.  \color{Red} fol. \color{black} \hyperlink{page.5}{5.}
\newline  \color{Red} Sono. \color{black} Ego sum Alpha, \& Omega, principium, \& finis, dicit Dominus Deus. Alleluia. \V Alleluia. Ego sum primus, \& novissimus: ego sum radix, \& origo David: ego sum stella splendida, \& matutina. Alleluia.
\newline  \color{Red} Lauda. \color{black} Laudate Dominum de C\oe lis. Alleluia. Laudate eum in excelsis. Alleluia, alleluia. Laudate eum omnes Angeli ejus: laudate eum omnes virtutes ejus. Alleluia, alleluia, alleluia. \color{Red} \hyperlink{ps148}{Psalmus 148.} \color{black}
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Esai\ae \ Prophet\ae . \itshape Capitulo \upshape 45. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} H}{}\AE c dicit Dominus: Labor \AE gypti, \& negotiatio \AE thiopi\ae , \& Sabaim viri sublimes ad te transibunt, \& tui erunt: Post te ambulabunt, vincti manicis pergent: \& te adorabunt, teque deprecabuntur: Tantum in te est Deus, \& non est absque te Deus. Vere tu es Deus absconditus, Deus Israel Salvator. Confusi sunt, \& erubuerunt omnes: simul abierunt in confusionem fabricatores errorum. Israel salvatus est in Domino salute \ae terna: non confundamini, \& non erubescetis in s\ae culum s\ae culi. Quia h\ae c dicit Dominus creans c\oe los, ipse Dominus formans terram, \& faciens eam, ipse plastes ejus: non in vanum creavit eam: ut habitaretur, formavit eam: ego Dominus, \& non est alius. Non in abscondito locutus sum in loco terr\ae \ tenebroso: non dixi semini Jacob: Frustra qu\ae rite me: ego Dominus loquens justitiam, annuntians recta. Congregamini, \& venite, \& accedite simul qui salvati estis ex Gentibus: nesciebant qui levabant sculpturas suas simul, \& rogant Deum non salvantem. Annuntiate, \& venite, \& consolamini simul: quis auditum fecit hoc, ex tunc pr\ae dixit illud? nunquid non ego Dominus, \& non est ultra Deus absque me? Deus justus, \& salvans non est pr\ae ter me. Convertimini ad me, \& salvi eritis omnes fines terr\ae . \R Amen.
\vspace{-.5em} \begin{center} \color{Red} Hymnus. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} H}{}Ostis Herodes impie,
\newline Christum venire quid times?
\newline \indent Non arripit mortalia,
\newline \indent Qui regna dat c\oe lestia.
\newline {\color{Red} I}bant Magi, quam viderant,
\newline \indent Stellam, sequentes pr\ae viam:
%pp143
\newline \indent Lumen requirunt lumine:
\newline \indent Deum fatentur munere.
\newline {\color{Red} L}avacra puri gurgitis
\newline \indent C\oe lestis Agnus attigit:
\newline \indent Peccata, qu\ae \ non detulit,
\newline \indent Nos abluendo sustulit.
\newline {\color{Red} N}ovum genus potenti\ae :
\newline \indent Aqu\ae \ rubescunt hydri\ae ,
\newline \indent Vinumque jussa fundere
\newline \indent Mutavit unda originem.
\newline {\color{Red} Q}uarto die jam f\oe tidus
\newline \indent Vitam recepit Lazarus,
\newline \indent Mortisque liber vinculis,
\newline \indent Factus superstes est sibi.
\newline {\color{Red} R}ivos cruoris horridi
\newline \indent Contacta vestis obstruit:
\newline \indent Fletu rigante supplicis
\newline \indent Arent fluenta sanguinis.
\newline {\color{Red} S}olutus omni corpore
\newline \indent Jussus repente surgere,
\newline \indent Suis vicissim gressibus
\newline \indent \AE ger vehebat lectulum.
\newline {\color{Red} T}unc ille Judas carnifex
\newline \indent Ausus Magistrum tradere
\newline \indent Pacem ferebat osculo,
\newline \indent Quam non gerebat pectore.
\newline {\color{Red} V}erax datur fallacibus:
\newline \indent Pium flagellat impius:
\newline \indent Crucique fixus innocens
\newline \indent Conjungitur Latronibus.
\newline {\color{Red} A}romata post Sabbatum
\newline \indent Qu\ae dam vehebant corpori,
\newline \indent Quas alloquuntur Angeli,
\newline \indent Vivum sepulcro non tegi.
\newline {\color{Red} H}ymnis venite dulcibus,
\newline \indent Omnes canamus subditum
\newline \indent Christi triumpho tartarum,
\newline \indent Qui nos redemit venditus.
\newline {\color{Red} Z}elum Draconis invidi,
\newline \indent Et os Leonis pessimi
\newline \indent Calcavit Unicus Dei,
\newline \indent Seseque c\oe lis reddidit.
\newline {\color{Red} G}loria tibi Domine,
\newline \indent Qui apparuisti hodie,
\newline \indent Cum Patre, Sancto Spiritu
\newline \indent In sempiterna s\ae cula. Amen.
\newline \color{Red} Supplicatio. \color{black} Oremus auctorem lucis. \color{Red} fol. \color{black} \hyperlink{page.82}{82.} Kyrie, eleison. \R Christe, eleison. Kyrie, eleison.
\vspace{-.5em} \begin{center} \color{Red} Capitula. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} G}{}Loriose, sancte, omnipotens Deus, qui varios humani generis miseratus semper errores, propterea sine dubio etiam Magis, in tenebrosa superstitione, sive caligine constitutis, pr\ae vium sideris lumen usque ad tua sancta cunabula ministrasti: ut omnibus generaliter, in suo errore degentibus, desiderium tu\ae \ agnitionis accenderes; accende nos etiam, precamur, salutifero tui amoris ardore: ut, qui te jam dono tu\ae \ illuminationis agnovimus, tu\ae \ quoque dilectionis ardore flagrantes, tibi adh\ae rere in perpetuum mereamur.
\par Pater noster. Liberati a malo. \color{Red} fol. \color{black} \hyperlink{page.2}{2.}
\newline \color{Red} Lauda. \color{black} Misit me sanare.
\newline \color{Red} Benedictio. \color{black} Benedicat vobis Alpha, \& Omega. \color{Red} fol. \color{black} \hyperlink{page.83}{83.}
\par In nomine Domini.
\par \color{Red} Octava Epiphani\ae , omnia dicantur, ut in die fol. \color{black} \hyperlink{APPARITIONIS-VES}{82.}
\vspace{-.5em} \begin{center} \color{Red} \hypertarget{DOM-PRIMO-POST-OCT-EPI-VES}
IN PRIMO DOMINICO\\
\color{black} P\textsc{ost} O\textsc{ctavam} E\textsc{piphani\ae} D\textsc{omini.}\\
\color{Red} Ad Vesperos.
\end{center} \vspace{-.5em}
\bookmark[dest=DOM-PRIMO-POST-OCT-EPI-VES,rellevel=-1]{IN PRIMO DOMINICO POST OCTAVAM EPIPHANI\AE \ DOMINI}
\bookmark[dest=DOM-PRIMO-POST-OCT-EPI-VES,rellevel=1]{AD VESPEROS}
\par \noindent \color{Red} Lauda. \color{black} Elevatio manuum mearum sacrificium. \P Vespertinum. \V Dirigatur, Domine, oratio mea in conspectu tuo sicut incensum. \P Vespertinum.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Eus, cujus nomen a solis ortu usque ad occasum laudabile est: sicut incensum in conspectu tuo nostra dirigatur oratio; tibique elevatio manuum nostrarum, sacrificium vespertinum, impleat solemnitatem. \R Amen. Per misericordiam tuam.
\newline \color{Red} Sono. \color{black} Alleluia. Ad vesperum demorabitur fletus: \& ad matutinum l\ae titia. Alleluia. \V Alleluia. Convertisti, Domine, planctum meum in gaudium mihi: conscidisti saccum meum, \& pr\ae cinxisti me l\ae titia. Alleluia. Dominus sit semper vobiscum. \R Et cum.
\newline \color{Red} Antiphona. \color{black} Qui est iste, cujus stell\ae \ splendiderunt in custodiis suis, \& l\ae tat\ae \ sunt, cum vocaret eas? reluxerunt cum l\ae titia ei, qui fecit eas. \V Fecit lunam in tempora: sol agnovit occasum suum. \P Et l\ae tat\ae \ sunt. \V Gloria, \& honor, \&c. \P Et l\ae tat\ae \ sunt. Dominus sit semper vobiscum. \R Et cum.
\newline \color{Red} Lauda. \color{black} Alleluia. Confitebor tibi Domine in directione cordis mei. Alleluia. \P In eo quod didici judicia justiti\ae \ tu\ae . Alleluia. \V In tuis justificationibus meditabor: non obliviscar sermones tuos. \P In eo quod. \V Gloria, \& honor Patri, \&c. \P In eo quod.
\vspace{-.5em} \begin{center} \color{Red} Hymnus. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} I}{}Nventor rutilis dux bone luminis,
\newline Qui certis vicibus tempora dividis,
\newline \indent Merso sole chaos ingruit horridum,
\newline \indent Lucem Christe tuis redde fidelibus.
\newline {\color{Red} S}plendent perspicuo lumine ardua,
\newline \indent Flammis mobilibus scilicet atria:
\newline \indent Absentemque diem lux agit \ae mula,
\newline \indent Noctem inluminans fulgore pr\ae vio.
\newline {\color{Red} N}os festis trahimus per pia gaudia
\newline \indent Noctem conciliis, votaque prospera
\newline \indent Concentu parili, suavi sonantibus
\newline \indent Hymnorum modulis ora resolvimus.
\newline {\color{Red} O} res digna Deus, quam tibi residu\ae 
\newline \indent Noctis principio Grex tuus offeret:
\newline \indent Luce, quam tribuis, nihil pretiosius,
\newline \indent Luce, qua reliqua pr\ae mia cernimus.
\newline {\color{Red} T}u lux vera oculis, lux quoque sensibus
\newline \indent Intus, tu speculum, fons: lumen
\newline \indent Quod delibat plebs tua, suscipe,
\newline \indent Tinctum pacifici chrismatis unguine.
\newline {\color{Red} P}er Christum Genitum summe Pater tuum,
\newline \indent In quo visibilis stat tibi gloria,
\newline \indent Qui noster Dominus, qui tuus Unicus
\newline \indent Spirat de patrio corde Paraclitum:
\newline {\color{Red} P}er quem splendor, honor, laus, sapientia,
\newline \indent Majestas, bonitas, \& pietas: Tu
\newline \indent Regnum contines Nomine triplici,
\newline \indent Texens perpetuis s\ae cula s\ae culis. Amen.
\newline \color{Red} Supplicatio. \color{black} Oremus Redemptorem. \color{Red} fol. \color{black} \hyperlink{page.63}{63.}
\vspace{-.5em} \begin{center} \color{Red} Capitula. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Irigatur oratio nostra Domine, sicut incensum in conspectu tuo: ut non patiaris in nobis demorari vespertinum fletum; sed l\ae titia tranquilla in matutinis sacrificiis tribuatur, suscipiantur orationes nostr\ae \ per Angelum tuum, sicut Tobi\ae \ \& Sar\ae \ desideria exaudire dignatus es: cura nos ab infirmitatibus nostris, \& sana omnes languores nostros; ut quemadmodum credimus diem hanc oblatam, noctis advenientis caligo diem vit\ae \ retributionis inveniat per eum, qui nos docuit orare.
\par Pater noster. Liberati a malo. \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.2}{2.}
\vspace{-.5em} \begin{center} \color{Red} Benedictio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} F}{}Lammam benedictionis c\oe lorum super vos Dominus benignus infundat, \& Trinitas inseparabilis a vobis nunquam recedat. \R Amen. Bella adversariorum vestrorum adterat, \& acies eorum ignis c\oe lestis consumat. \R Amen. Dominetur in vobis charitas individua, \& conservet vos sempiterna majestas. \R Amen. Per misericordiam ipsius.
\newline \color{Red} Lauda. \color{black} Bonitatem, \& disciplinam, \& scientiam doce me, Deus: Alleluia. \P Quia mandatis tuis credidi. Alleluia, alleluia, alleluia. \V Cogitavi vias meas: \& converti pedes meos in testimonia tua. \P Quia mandatis. \V Gloria, \& honor, \&c. \P Quia mandatis.
\par \color{Red} Oratio. \color{black} Domine Jesu Christe, qui credentes in te. \color{Red} Require in Matutinis istius Dominici. fol. \color{black} \hyperlink{page.3}{3.}
\par \color{Red} \hypertarget{DOM-PRIMO-POST-OCT-EPI-MAT} In principio Matutini dicimus per dies Dominicos, scilicet: \color{black}
\bookmark[dest=DOM-PRIMO-POST-OCT-EPI-MAT]{AD MATUTINUM}
\newline Hymnus. \hyperlink{page.3}{\AE terne rerum Conditor.}
\newline \color{Red} Oratio. \color{black} \AE ternum te auctorem. \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.3}{3.}
\newline \color{Red} Antiphona. \color{black} Domine quid multiplicati sunt qui tribulant me? Tu autem Domine susceptor meus es. \color{Red} \hyperlink{psalm3}{Psalmus 3.} \color{black}
\newline \color{Red} Antiphona. \color{black} Lava me ab injustitia mea: \& a peccato meo munda me Domine. \color{Red} \hyperlink{psalm50}{Psalmus 50.} \color{black}
\newline \color{Red} Antiphona 3. \color{black} In te confidit anima mea, libera me, Domine. \color{Red} \hyperlink{psalm56}{Psalmus 56.} \color{black}
\newline \color{Red} Antiphona. \color{black} Domine quid multiplicati sunt qui tribulant me? Tu autem Domine susceptor meus es. \V Gloria, \& honor Patri, \& Filio, \& Spiritui Sancto.
\newline \color{Red} Antiphona. \color{black} Lava me ab injustitia mea: \& a peccato meo munda me Domine. \V Sicut erat in principio, \& nunc, \& semper.
\newline \color{Red} Antiphona. \color{black} In te confidit anima mea: libera me, Domine. \P Et in s\ae cula s\ae culorum. Amen.
\newline \color{Red} Oratio. \color{black} Domine Jesu Christe, qui credentes. \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.3}{3.}
\newline \color{Red} Antiphona 1.  \color{black} Servite Domino in timore: \& exultate ei cum tremore. Apprehendite disciplinam. \P Nequando irascatur Dominus, \& pereatis a via justa. \V Quare fremuerunt Gentes, \& populi meditati sunt inania? \P Nequando. \V Gloria, \& honor, \&c. \P Nequando.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} S}{}Ervientes tibi Domine in timore, disciplina tua nos erudiendo possideat; \& exultantes cum tremore jocunditas modesta sustollat: nec nos efficiamur a via justa recedendo perditi; sed in te confidendo mereamur esse beati. \R Amen. Per misericordiam.
\newline \color{Red} Antiphona 2. \color{black} In tribulatione nostra, Deus, dilatasti nos. \P Miserere nobis, \& exaudi orationem nostram. \V Cum invocarem, exaudisti me Deus justiti\ae \ me\ae : in tribulatione mea dilatasti mihi. Miserere mei, \& exaudi orationem meam. \P Miserere nobis, \& exaudi. \V Gloria, \& honor, \&c. \P Miserere nobis.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine, qui semper invocantibus ades, \& in tribulatione constitutis opem ferre
%pp145
misericordi\ae \ delectaris: dona, ut odientes s\ae culi vanitatem, refutantesque mendacium, Christum tuum, (quem a te magnificatum agnoscimus) nostrum esse summum \ae ternumque pr\ae mium gaudeamus. \R Amen. Per misericordiam.
\newline \color{Red} Antiphona 3. \color{black} Convertere Domine, eripe animas nostras: salvos nos fac propter misericordiam tuam. \P Quia non est in morte qui memor sit tui. \V Domine, ne in ira tua arguas me, neque in furore tuo corripias me. \P Quia non est. \V Gloria, \& honor, \&c. \P Quia non est.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine neque in ira tua nos arguas; neque in tuo nos furore corripias: sed ab asperitate verberis unge nos clementia lenitatis: ut non perditionem p\oe na; sed eruditionem nobis tua conferat disciplina. \R Amen. Per misericordiam.
\newline \R Abundaverunt iniquitates nostr\ae \ super numerum aren\ae \ maris. \P Et nunc juste comprimimur ad nos erigendum caput nostrum: peccavimus, Domine, peccavimus. \V Peccavimus cum patribus nostris: injuste egimus, iniquitates fecimus. \P Et nunc juste. \V Gloria, \& honor, \&c. \P Et nunc.
\vspace{-.5em} \begin{center} \hypertarget{DOM-PRIMO-POST-OCT-EPI-LAU}
IN LAUDIBUS.\\
\color{Red} Ad Canticum.
\end{center} \vspace{-.5em}
\bookmark[dest=DOM-PRIMO-POST-OCT-EPI-LAU]{IN LAUDIBUS}
\par \noindent \color{Red} Antiphona. \color{black} Date magnitudinem Domino.
\newline \color{Red} Canticum. \color{black} Attende C\oe lum. \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.4}{4.}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Escendat, Domine, ut pluvia eloquium tuum; \& sicut ros, verba tua super nos effundantur: ut, ubertim tua miseratione rigati, tibi magnitudinem demus, cujus opera bona esse cognoscimus: omnes vi\ae \ tu\ae , judicia; \& iniquitas procul est a rectitudine tua: proinde nos, qui proclives ad malum sumus, a tua gubernatione, etiam cum tui obliviscimur, non defraudemur: ut \& si serviliter facinore sciscitamur, lenitate paterna a te corrigi sentiamus. \R Amen. Per misericordiam.
\vspace{-.5em} \begin{center} \color{Red} Ad Benedictus. \color{black} \end{center} \vspace{-.5em}
\par \noindent \color{Red} Antiphona. \color{black} Benedictus es Deus, \& benedictum nomen glori\ae \ tu\ae . Benedicite Dominum omnes electi ejus: sit nomen sanctum ipsius benedictum in omnia s\ae cula s\ae culorum.
\newline \color{Red} Canticum. \color{black} Benedictus es Domine. \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.5}{5.}
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} D}{}Omine Deus patrum nostrorum; laudabilis enim \& superexaltatus in s\ae cula tu es: Recte ergo tu\ae \ glori\ae \ nomen benedicetur in \ae ternum; \& vel in magnis vel in modicis tu creator, tu opifex sapientissimus declamaris: ideo qu\ae sumus; ut qui te orando pro universitatis conditione Dominum benedicimus, benedict\ae \ sanctitatis illustratione l\ae temur. \R Amen. Per misericordiam.
\newline \color{Red} Sono. \color{black} Verba mea auribus percipe Domine. Alleluia. \V Intellige clamorem meum rex meus, \& Deus meus. Quoniam ad te orabo. Alleluia.
\newline \color{Red} Lauda. \color{black} Laudate Dominum de C\oe lis: Alleluia, alleluia. Laudate eum in excelsis, alleluia, alleluia, alleluia. \color{Red} \hyperlink{psalm148}{Psalmus 148.} \color{black}
\vspace{-.5em} \begin{center} {\color{Red} L}ectio libri Proverbiorum Salomonis. \itshape Capitulo \upshape 25. \color{black} \end{center} \vspace{-.5em}
\par \noindent \R Deo gratias.
\lettrine[lines=2]{\bfseries \color{Red} G}{}Loria Dei celare verbum, \& gloria regum investigare sermonem. C\oe lum sursum, \& terra deorsum, \& cor regum inscrutabile. Aufer rubiginem de argento, \& egredietur vas purissimum. Aufer impietatem de vultu regis, \& firmabitur justitia thronus ejus. Ne gloriosus appareas coram rege, \& in loco magnatorum ne steteris. Melius est enim ut dicat tibi: Ascende huc; quam ut humilieris coram principe. Qu\ae \ viderint oculi tui, ne proferas in jurgium cito: ne postea emendare non poteris, cum dehonestaveris amicum tuum. Causam tuam tracta cum amico tuo, \& secretum extraneo ne reveles: ne forte insultet tibi cum audierit, \& exprobrare non cesset. Mala aurea in lectis argenteis, qui loquitur verbum in tempore suo. Inauris aurea, \& margarita fulgens, qui arguit sapientem, \& aurem obedientem. Sicut frigus nivis in die messis, ita legatus fidelis ei, qui misit eum, cum requiescere facit animam illius. \R Amen.
\newline \color{Red} Hymnus. \color{black} Splendor patern\ae \ glori\ae . \color{Red} Qu\ae re fol. \color{black} \hyperlink{page.65}{65.}
\newline \color{Red} Supplicatio. \color{black} Oremus Redemptorem mundi Dominum. \color{Red} Qu\ae re fol. \color{black} \color{black} \hyperlink{page.63}{63.}
\vspace{-.5em} \begin{center} \color{Red} Capitula. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} E}{}Xultantes gaudio magno pro redditu nobis hujus diei, lucem Dei Patris omnipotentis \& misericordiam deprecemur, ut diem Dominic\ae \ Apparitionis solemniter celebrantibus pacem tranquillam, l\ae titiamque specialem pr\ae stare dignetur: ut a vigilia matutina usque ad noctem clementi\ae \ su\ae \ favore protecti, exultantes in Domino gaudeamus.
%pp146
\par Pater noster. Liberati a malo. \color{Red} fol. \color{black} \hyperlink{2.}{2.}
\newline \color{Red} Lauda. \color{black} Cantate Domino canticum novum. Alleluia, alleluia. \V Laus ejus in Ecclesia sanctorum. \P Alleluia, alleluia. \V Gloria, \& honor, \&c. \P Alleluia, alleluia.
\vspace{-.5em} \begin{center} \color{Red} Oratio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} T}{}Ibi Domine in Ecclesia sanctorum cantamus; tibique gratiam pr\ae conamus: tribue nobis, laudes tuas promere; in quo co\ae ternum nos credimus pr\ae mium obtinere. \R Amen. Per misericordiam.
\newline \color{Red} \hypertarget{DOM-PRIMO-POST-OCT-EPI-VES-II}{Exeunte vespera} Lauda. \color{black} Usque ad vesperum quam magnificata sunt opera tua, Domine. Dominus sit semper vobiscum. \R Et cum.
\bookmark[dest=DOM-PRIMO-POST-OCT-EPI-VES-II]{EXEUNTE VESPERA}
\newline \color{Red} Antiphona. \color{black} Cantet tibi gloria mea, \& non compungar. \P Domine Deus meus in \ae ternum confitebor tibi. \V H\ae c facta est mihi: quia justificationes tuas exquisivi. \P Domine Deus meus. \V Gloria, \& honor. \P Domine Deus. Dominus sit semper vobiscum. \R Et cum.
\newline \color{Red} Antiphona. \color{black} Elevatio manuum mearum sacrificium vespertinum. \V Dirigatur oratio mea, sicut incensum in conspectu tuo. \P Elevatio. \V Gloria, \& honor, \&c. \P Elevatio. Dominus sit semper vobiscum. \R Et cum.
\newline \color{Red} Lauda. \color{black} Laudate pueri Dominum: laudate nomen Domini. Alleluia. \P Sit nomen Domini benedictum. Alleluia, alleluia. \V A solis ortu usque ad occasum, laudabile nomen Domini. \P Sit nomen Domini. \V Gloria, \& honor, \&c. \P Sit nomen.
\vspace{-.5em} \begin{center} \color{Red} Hymnus. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} A}{}Ltissimi Verbum Patris,
\newline Alme Jesuque Virginis
\newline \indent Bis nostro natus gaudio,
\newline \indent Carnisque Factor \& caro.
\newline {\color{Red} D}ecursa transit jam dies,
\newline \indent Exaudi preces supplicum;
\newline \indent Fovensque l\ae tus vesperi
\newline \indent Gloriosum lumen suscipe.
\newline {\color{Red} H}oc soli ad finem tibi
\newline \indent Incensum sacrum damus;
\newline \indent C\oe leste ut nostris tuum
\newline \indent Lumen tenebris fulgeat.
\newline {\color{Red} M}entemque fessam dum sopor
\newline \indent Noctis paratam detinet,
\newline \indent Obscura cedant somnia,
\newline \indent Pectusque purum luceat.
\newline {\color{Red} Q}uietem nullus corporis
\newline \indent Rapiat dolus lascivi\ae ;
\newline \indent Sed te Deus mens sonet,
\newline \indent Tecum cor altum vigilet.
\newline {\color{Red} V}ocibus simul cum cordibus
\newline \indent Christo, Patrique, Spiritui
\newline \indent Hymnum sonantes in choro
\newline \indent Melo canamus perpetim. Amen.
\vspace{-.5em} \begin{center} \color{Red} Supplicatio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} O}{}Remus pium \& exaudibilem Dominum nostrum Jesum Christum, cum omni supplicatione rogemus; ut nobis salutem anim\ae \ \& corporis, \& remissionem peccatorum, \& pacem propitius tribuere dignetur. \R Pr\ae sta \ae terne omnipotens Deus.
\vspace{-.5em} \begin{center} \color{Red} Capitula. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} O}{}Mnipotens sempiterne Deus, cujus pr\ae cepto sol illustrat diem, luna clarificat noctem, vespertinis laudibus nos dignanter exaudi: ut \& placidum supervenientis spatium peragere mereamur, \& transacto tenebrarum cursu, matutinis nos iterum sacrificiis apta, ne ullam offensionum maculam dies repr\ae sentet exoriens.
\par Pater noster. Liberati a malo. \color{Red} fol. \color{black} \hyperlink{page.2}{2.} Humiliate vos benedictioni. Dominus sit semper vobiscum. \R Et cum.
\vspace{-.5em} \begin{center} \color{Red} Benedictio. \color{black} \end{center} \vspace{-.5em}
\lettrine[lines=2]{\bfseries \color{Red} B}{}Enedicat omnipotens Dominus pr\ae sentem familiam, qui Crucis portavit injuriam. \R Amen. Ipse nos perducat c\oe leste in regnum, qui pependit in ligno. \R Amen. Ipse ad dexteram Patris nos conlocet, qui causa nobis factus est pacis. \R Amen. Per misericordiam ipsius.
\newline \color{Red} Lauda. \color{black} Cantabiles erant mihi, Domine. \P Justificationes tu\ae . Alleluia, alleluia, alleluia. \V H\ae c facta est mihi: quia justificationes tuas exquisivi. \P Justificationes. \V Gloria, \& honor, \&c. \P Justificationes.
\newline \color{Red} Oratio. \color{black} Concede nobis, Domine, ob amorem. \color{Red} Qu\ae re infra in istis Matutinis. \color{black}
\par In nomine Domini nostri.
\par \color{Red} Istis peractis, fiat Commemoratio de Devotatione Ecclesi\ae , \& aliarum festivitatum, quarum devotionem habes. \color{black}
\vspace{-.5em} \begin{center} \hypertarget{MON-MAT}
FERIA SECUNDA.\\
\color{Red} Ad Matutinum.
\end{center} \vspace{-.5em}
\bookmark[dest=MON-MAT,rellevel=-1]{FERIA SECUNDA}
\bookmark[dest=MON-MAT,rellevel=1]{AD MATUTINUM}
\par \noindent \color{Red} Antiphona. \color{black} Miserere mei Deus secundum magnam misericordiam tuam. \color{Red} \hyperlink{psalm50}{Psalmus 50.} \color{black}
...
Miserere nobis Domine secundum magnam misericordiam tuam: et unde nos erubescimus, tu indulgeas: et ea, qu\ae \ egisse nos p\oe nitet, tu clementer ignoscas.
\R Amen.
...
Concede nobis, Domine, ob amorem beatitudinis consilia declinare iniquitatis; cathedram itaque pestilenti\ae \ procul a nobis sepone, ut pestifer\ae \ doctrin\ae \ tabes non adh\ae reat conviventi\ae \ nostr\ae ; sed voluntatem nostram a maliti\ae \ sessione tu remove: et meditatione legis tu\ae \ jugi nos tibi amore conjunge.
\R Amen.
...
Servientes tibi Domine in timore ob metum judicii, exultantes cum tremore ob fiduciam spei, doce nos apprehendere disciplinam, qua, judicantes terram corporis nostri, veteris hominis figulum confringamus; et exterioris terr\ae \ purgamenta calcemus: ac secundum C\oe lestis imaginem Hominis reformati, in hereditatem tuam servitute humili, et in possessionem tuam cultu perpeti transferamur.
\R Amen.

Per misericordiam tuam.

Antiphona 3. Sacrificate sacrificium justiti\ae , et sperate in Domino. Psalmus 4.

Oratio.

Domine, qui semper invocantibus ades, et in tribulatione constitutis opem ferre misericordi\ae \ delectaris: dona, ut odientes s\ae culi vanitatem, refutantesque mendacium, Christum tuum (quem a te magnificatum agnoscimus), nostrum esse summum \ae ternumque pr\ae mium gaudeamus.
\R Amen.
...
Antiphona. Benedicam enim vobis, et multiplicabo vos sicut stellas c\oe li, dicit Dominus.
...
Benedicam benedicentibus tibi, et maledicam maledicentibus tibi, * atque in te benedicentur univers\ae \ cognationes terr\ae .
...
Benedicam enim vobis, * et multiplicabo vos sicut stellas c\oe li, et velut arenam, qu\ae \ est in littore maris:
Possidebit semen tuum portas inimicorum tuorum, * et benedicentur in semine tuo omnes gentes terr\ae .
Ego Dominus, qui eduxi te de Ur Chald\oe orum, ego Deus omnipotens: * ambula coram me, et esto perfectus.
Ponamque f\oe dus meum inter me et te, * et multiplicabo te vehementer nimis. Ego sum, et pactum meum tecum,
Erisque pater multarum gentium. * Et ponam te in gentibus, regesque ex te egredientur.
Et statuam pactum meum inter me et te, et inter semen tuum post te in generationibus suis, f\oe dere sempiterno: * ut sim Dominus Deus tuus, et semini tuo post te.
Daboque tibi et semini tuo terram peregrinationis tu\ae , * in possessionem \ae ternam, eroque Deus eorum.
...
\P Laudate Dominum in sanctis ejus. Alleluia, alleluia. \V Gloria, et honor Patri, et Filio, et Spiritui Sancto. \P Laudate eum in firmamento virtutis ejus. \V Sicut erat in principio, et nunc et semper, et in s\ae cula s\ae culorum. Amen. \P Alleluia, alleluia.

Lectio libri Proverbiorum Salomonis. Capitulo 3.

\R Deo gratias.

Fili, Habe fiduciam in Domino ex toto corde tuo, et ne innitaris prudenti\ae \ tu\ae . In omnibus viis tuis cogita illum, et ipse diriget gressus tuos. Ne sis sapiens apud 96 temetipsum: time Dominum, et recede a malo.

\R Amen.

Hymnus.

   Fulgentis auctor \ae theris,
Qui lun\ae \ lumen noctibus,
...
Oremus Redemptorem mundi Dominum nostrum Jesum Christum, cum omni supplicatione rogemus; ut per gratiam ipsius, et per intercessionem Sanct\ae \ Mari\ae \ Virginis, et genitricis su\ae , et omnium Sanctorum suorum nobis salutem anim\ae , et corporis, et remissionem peccatorum, et pacem propitius tribuere dignetur.
\R Pr\ae sta, \ae terne omnipotens Deus.
...
Rex noster, et Deus noster depelle a cordibus nostris erroris, et ignoranti\ae \ noctem; ut renovando nos in novum hominem, mane nostras exaudiens voces, fac nos in bonis operibus tibi adstare diluculo; et ad contemplandum te, nobis Apparitionis tu\ae \ tribue sacramentum.
...
Benedictio. Benedicat omnipotens Dominus. Qu\ae re fol. 94.

Et sic finiuntur Matutini in Benedictionibus. Et statim fac Commemorationes Vocationis Ecclesi\ae , et alias quas volueris in quibus devotionem habueris. Postea Pater noster sub silentio; quo finito, fiat commemoratio.

Lauda. Ad annuntiandum mane.

Oratio. Mane, Domine, oratio. Qu\ae re fol. 7.

Lauda de fonte. Apud te est, Domine, fons vit\ae . Alleluia. \V Et in lumine tuo videbimus lumen. \P Alleluia. \V Gloria, et honor, etc. \P Alleluia.
...
Fili, Custodi sermones meos, et pr\ae cepta mea reconde tibi. Serva mandata mea, et vives.

\R Amen.

Antiphona 1. Intellige clamorem meum, Domine. Intende voci orationis me\ae .
...
Domine, ne in ira tua nos arguas; neque in tuo nos furore corripias: sed asperitatem verberis unge clementia lenitatis: ut non perditionem p\oe na; sed eruditionem nobis tua conferat disciplina.
\R Amen.
...
Preces: Alius non est, qui rogetur, pie Domine: \V Alleva jugum, colla prementum inclina. \P Pie, bella reprime, pacem concede. \V Captivos eripe, demersos erige. \P Pie, bella. \V Dona veniam, pr\ae sta gratiam, pie Domine. Reiteretur primus \V Preces scilicet: Alius non est.

Capitula.

Gloriose, potens, ac misericors Deus, erue nos ab insidiis inimici; et ne anima nostra rugientis leonis raptu rapido rapiatur, protectio dexter\ae \ tu\ae \ in nostri custodiam deputetur: nedum non est qui redimat, ill\ae \ s\ae vus occidat: aut, si non qui salvum faciat, ille subvertat. Sed tu Leo de tribu Juda in ira tua exurge; et severitate judicii insidiosi hostis catervas interime: nosque in pr\ae cepto, quod mandasti, credere et permanere concede.
...
Supplicatio. Oremus Redemptorem mundi. Qu\ae re fol. 96.

Kyrie, eleison. \R Christe, eleison. Kyrie, eleison.

Capitula.

Illuminatio salusque nostra, Domine, amove a nobis m\oe roris, et ignoranti\ae \ noctem; tribue veritatis, et scienti\ae \ lumen, ut in te nostra spes fixa permaneat; et omnis conventus malignantium, qui nos oppugnare nititur, contabescat: Sit in petra exaltatio nostra; ut conroborati per Christum, in ipso efficiamur charitate sublimes, in quo \ae dificamur fide credentes.
...
Lauda. Super Sion alleluia montem sanctum ejus Alleluia \P Pr\ae dicans pr\ae ceptum Domini. Alleluia, alleluia, alleluia. \V Ego autem constitutus sum rex ab eo super Sion montem sanctum ejus. \P Pr\ae dicans pr\ae ceptum Domini. \V Gloria, et honor, etc. \P Pr\ae dicans pr\ae ceptum.
...
Secundum multitudinem miserationum tuarum dele Domine iniquitates nostras: ut quia ist\ae \ nos aggravant, ill\ae \ nos erigant: Cor contritum et humiliatum ne spernas in nobis: sed per ineffabilem potentiam Trinitatis inhabitet in nobis Spiritus Sanctus; innovet spiritus rectus; confirmet spiritus principalis; atque unius testimonii sit virtus: ut confirmatos nos per Patrem, et innovatos per Filium, custoditos nos esse gaudeamus per Spiritum Sanctum.
\R Amen.

Per misericordiam tuam.

Antiphona 1. L\ae tabor et exultabo in te: et 98 psallam nomini tuo Altissime.

Psalmus 9.

Oratio.

In toto corde nostro confitebimur nomini tuo Domine, quod inimicum nostrum retrorsum redire fecisti; dum eum potentialiter ignea catena vinxisti; et nos de portis mortis, passionis tu\ae \ victoria liberasti. Esto nunc, qu\ae sumus, custos redemptorum, qui pretium factus es peccatorum: esto refugium pauperum, defensio viduarum, et protectio pupillorum: ut dum singulorum necessitatibus singulari favore subveneris, singulari fide a cunctis incessabiliter collauderis.
\R Amen.
...
Averte Domine inimicos nostros retrorsum; ut, dum aspicis, infirmentur; atque ipse adjutor in opportunitatibus in tribulatione, opportunitatum nobis gratiam pr\ae sta; et tribulationum pondus attenua: ut nec prosperitas nos revocet ad negligentiam, nec angustia pertrahat ad ruinam: sed miseratio tua nos perducat ad veniam.
\R Amen.
...
Desiderium tuorum Domine pauperum sic intende propitius, ut et donorum c\oe lestium copiam nobis tribuas; et amorem pr\ae tereuntium rerum a nobis avertas: auris quoque tua nostram ita orationem intelligat, ut dum pupillo humilique judicium feceris, paterna nobis indulgentia blandiaris; et pro humiliatione pr\ae sentium gaudia retribuas \ae ternorum.
\R Amen.
...
Det tibi Dominus de rore c\oe li, et de pinguedine terr\ae , abundantiam frumenti, vini, et olei, * et adorent te tribus:
Esto Dominus fratrum tuorum, * et incurventur ante te filii matris tu\ae :
Deus autem omnipotens benedicat tibi, * et crescere te faciat, atque multiplicet: ut sis in turmas populorum.
Et det tibi benedictiones Abraham, et semini tuo post te: * ut possideas terram peregrinationis tu\ae .
...
Prophetia. Fili, Habe fiduciam in Domino. Qu\ae re fol. 95.

Hymnus.

   Deus \ae terni luminis
Candor inenarrabilis,
Venturus diei judex,
Qui mentis occulta vides.
   Tu regnum c\oe lorum tenes,
...
Tibi divinus est honor.
   ...
   Christoque, \ae terno Deo
Patri, cum Sancto Spiritu,
In te solvamus munera
A s\ae culis in s\ae cula.
   Amen. 99
...
Auribus tuis, omnipotens Deus, percipe verba oris nostri; et tuorum diluculo clamorem pie scrutator intellige: ac tu\ae \ voluntatis scuto ita nos pr\ae muniri concede, ut vitiosa suggestio mentis nostr\ae \ non valeat inrepere: sit quoque orandi ad te jugis ac fida devotio, ut contemplatio tua nobis tribuatur in matutino.
...
Benedictio. Dignare, Domine, hanc. Qu\ae re fol. 97.

Et statim fac commemorationes, quas consuevisti facere, scilicet. Ad annuntiandum mane misericordiam tuam, etc.

Oratio. Mane, Domine, oratio nostra. Qu\ae re fol. 7.

Lauda de fonte. Fons iste vit\ae \ nobis es. Alleluia. \P Quia Sanctis tuis circumdatus es. Alleluia. \V Rigans montes de superioribus tuis: de fructu operum tuorum satiabitur terra. \P Quia Sanctis tuis. \V Gloria, et honor, etc. \P Alleluia, alleluia.

Ad Tertiam.

Prophetia. Fili, Custodi sermones. Qu\ae re fol. 96,

Antiphona 1. Justus Dominus et justitiam dilexit: \ae quitatem vidit vultus ejus.

Psalmus 10.

Oratio.

Justus es, Domine, et justitiam diligis, atque aspicis \ae quitatem: dona nobis ante oculos tuos tibi placita et placitura perficere; et semper digna tu\ae \ justiti\ae \ atque \ae quitatis opera consummare.
\R Amen.
...
Custodi nos, Domine, in generatione, et progenie; nec cum pr\ae senti volvamur s\ae culo, qui tuo jam inb\ae simus fundamento: sed miseriarum nostrarum consolator exurge, et proventu l\ae titi\ae \ m\oe rores nostros absterge.
\R Amen.
...
Lauda. Alleluia, alleluia. Magnus Dominus noster, et magna virtus ejus: \P Alleluia. \V Et sapienti\ae \ ejus non est numerus. \P Alleluia, alleluia. \V Gloria, et honor, etc. \P Alleluia, alleluia.

Preces. Exaudi nos, Deus. \P Exaudi. \V Ad te clamantes, Deus. \P Exaudi. \V Bone Redemptor Deus. \P Exaudi. \V Contritos corde, Deus. \P Exaudi. \V De tuis c\oe lis, Deus. \P Exaudi.

Capitula.

Respice, et exaudi nos, Domine Deus noster; et ad placandum tibi conatus nostros adjuva, quos ipse tribuisti: da finem operis, qui dedisti principium voluntatis: da, ut possimus implere, qu\ae \ dedisti, ut velimus incipere.

Pater noster. A malo nos libera. Qu\ae re fol. 10.
...
Antiphona. In advertendo Dominus captivitatem plebis su\ae , l\ae tetur Jacob, et exultet Israel. Psalmus 13. Dominus sit semper vobiscum. \V Et cum.

Lauda. Irascimini, et nolite peccare. Alleluia. Dicite in cordibus vestris, et in cubilibus vestris compungimini. \P Alleluia, alleluia, alleluia. \V Sacrificate sacrificium justiti\ae , sperate in Domino: multi dicunt: Quis ostendit nobis bona? \P Alleluia. \V Gloria, et honor, etc. \P Alleluia, alleluia, alleluia. 100
...
Lauda. Gloriabuntur in te omnes, qui diligunt nomen tuum, Domine, Alleluia. \P In \ae ternum, et exultabunt. Alleluia. \P Et inhabitabis in eis. Alleluia, alleluia, alelluia. \V Et l\ae tentur in te omnes, qui sperant in te. \P In \ae ternum. \V Gloria, et honor Patri, etc. \P Et inhabitabis.

Oratio.

Notas fac, Domine, vias vit\ae ; atque imple nos delectatione dexter\ae \ tu\ae : et jugum, quod suave est, ipsa super nos manus tu\ae \ moderatione constitue.
\R Amen.
