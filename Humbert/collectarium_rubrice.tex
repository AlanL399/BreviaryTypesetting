...
\newline Per eumdem dominum nostrum Ihesum Christum filium tuum, Qui tecum. \ul{et cetera. Ut illa in die Natalis,} \hyperlink{concede-nativitas}{Concede quesumus omnipotens deus ut nos unigeniti.} \ul{Quedam per,} Qui tecum vivit, \ul{etc ut prius sicut est illa in die Circumcisionis.} \hyperlink{deus-nobis-circumcisionis}{Deus qui nobis nati,} \ul{et consimiles. Sunt et alie orationes que ad patrem diriguntur, in fine quarum fit mentio de filio, et hoc vel per rectum hoc modo.}
...
% \lettrine[lines=2]{\zallmancaps \color{Blue} C}{arnis} resurrectionem. \R Vitam eternam amen. \V Dignare domine nocte ista. {\color{Red} Vel.} die isto. \R Sine peccato nos custodire.
...
% \lettrine[lines=2]{\zallmancaps \color{Blue} F}{idelium} anime per misericordiam dei requiescant in pace. \R Amen.
...
% \newline {\color{Red} B}enedictione perpetua benedicat nos pater eternus. Amen.
...
% \newline {\color{Red} I}n tribulatione et angustia subveniat nobis pia virgo Maria.
...
% \lettrine[lines=2]{\zallmancaps \color{Red} D}{eus} cui proprium est misereri semper et parcere, suscipe deprecationem nostram, et quos delictorum catena constringit, miseratio tue pietatis absolvat. Per Christum.
...
% {\color{Red} \ubsubsection{De Oratione Pro Capitulo Generali, et Pro Pergentibus Ad Illud}{de-oratione-pro-capitulo-generali-collectarium}}
% \newline \ul{Dicto psalmo,} \psalm{122} \ul{et Antiphona,} Veni sancte, \ul{et} Pater noster. \ul{Subiungatur legendo,} Et ne nos. \V Emitte spritum sanctum. \V Salvos fac. Dominus vobiscum. Oremus. {\color{Red} Oratio.} {\color{Red} D}eus qui corda \ul{et cetera.}
% \lettrine[lines=2]{\zallmancaps \color{Red} A}{desto} domine supplicationibus nostris, et viam famulorum tuorum in salute tue prosperitate dispone, ut inter omnes vie et vite huius varietates, tuo semper protegantur auxilio. Pr Christum.
{\color{Red} \ubsubsection{De Benedictione Itinerantium}{de-benedictione-itinerantium-collectarium}}
...
% \newline \ul{Finitis que de Kalendario, luna, et martyrologio pronuncianda sunt: subiungatur.} {\color{Red} Versus.}
...
% \newline \ul{Data benedictione sequitur lectio de evangelio, vel de constitutionibus: Fratres tamen qui extra conventum sunt: si evangelium proprium in promptu non habuerint: dicant.} {\color{Red} Secundum Iohannem.}
