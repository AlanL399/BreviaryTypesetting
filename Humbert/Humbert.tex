...
% Note that in the Dominican rite, responsories are repeated only in semiduplex and higher, so three lessons and simples, the first line is not repeated.
...
\begin{center}
\begin{tabular}{l | l | l | r | l r}
\multicolumn{2}{l}{\color{Red}Aureus} & & & \color{Red} \\
\multicolumn{2}{l}{\color{Red}numer.} & & & \color{Red} \\
...
\begin{center}
\begin{tabular}{l | l | l | r | l r}
\multicolumn{2}{l}{\color{Red}Aureus} & \color{Red} Kal. & & \color{Red} \\
\multicolumn{2}{l}{\color{Red}numer.} & & & \color{Red} \\
