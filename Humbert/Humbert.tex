...
% Define the responsory-prolix environment allows us to add a word after the doxology
\NewDocumentEnvironment{responsory-prolix}{O{} m m m}{%
	\hypertarget{#1}{\label{#1}}
	\def\firstline{#2}%
	\def\versicle{#3}%
	% \StrBefore{\firstline}{*}[\partone]%
...
\titlespacing*{\subsection}
  {0pt}     % Left margin
  {5pt}    % Space before (adjust as needed)
